import{c as Re,i as _f,a as he,b as re,M}from"./messageSchema-D88_8mM8.js";const X={TAB_NOT_FOUND:"TAB_NOT_FOUND",CONTENT_SCRIPT_NOT_READY:"CONTENT_SCRIPT_NOT_READY",MESSAGE_SEND_FAILED:"MESSAGE_SEND_FAILED",SESSION_CREATE_FAILED:"SESSION_CREATE_FAILED",INPUT_SEND_FAILED:"INPUT_SEND_FAILED",OUTPUT_FETCH_FAILED:"OUTPUT_FETCH_FAILED",TIMEOUT:"TIMEOUT",OPERATION_FAILED:"OPERATION_FAILED",INVALID_INPUT:"INVALID_INPUT",EMPTY_PROMPT:"EMPTY_PROMPT",INVALID_TAB_ID:"INVALID_TAB_ID",AUTH_FAILED:"AUTH_FAILED",AUTH_EXPIRED:"AUTH_EXPIRED",NETWORK_ERROR:"NETWORK_ERROR",RATE_LIMIT_EXCEEDED:"RATE_LIMIT_EXCEEDED",QUOTA_EXCEEDED:"QUOTA_EXCEEDED",STORAGE_ERROR:"STORAGE_ERROR",UNKNOWN_ERROR:"UNKNOWN_ERROR"};function _t(n){return{success:!0,data:n}}function le(n,e,t,r){return{success:!1,error:{code:n,message:e,context:t,details:r}}}function ln(n,e){const t=(n==null?void 0:n.message)||String(n);return le(X.UNKNOWN_ERROR,t,e,n==null?void 0:n.stack)}const _r=Re("Platform/Messaging");function yf(n){const e=(t,r,s)=>{if(!_f(t)){_r.warn("Received invalid message",{message:t,sender:r});const i=he(t||{},X.INVALID_INPUT,"Message does not follow schema");return s(i),!1}return _r.debug("Received message",{type:t.type,correlationId:t.correlationId,from:r.tab?`tab:${r.tab.id}`:"extension"}),(async()=>{try{const i=await n(t,r);s(i)}catch(i){_r.error("Message handler error",{error:i,type:t.type,correlationId:t.correlationId});const a=he(t,X.UNKNOWN_ERROR,(i==null?void 0:i.message)||"Handler error");s(a)}})(),!0};return chrome.runtime.onMessage.addListener(e),_r.info("Message listener registered"),()=>{chrome.runtime.onMessage.removeListener(e),_r.info("Message listener removed")}}const Pt=Re("MessageRouter"),Dr=new Map;function fe(n,e){Dr.has(n)&&Pt.warn("Overwriting existing handler",{messageType:n}),Dr.set(n,e),Pt.debug("Handler registered",{messageType:n})}async function Ef(n,e){const{type:t,correlationId:r}=n;Pt.debug("Routing message",{type:t,correlationId:r,from:e.tab?`tab:${e.tab.id}`:"extension"});const s=Dr.get(t);if(!s)return Pt.warn("No handler for message type",{type:t,correlationId:r}),he(n,X.UNKNOWN_ERROR,`No handler registered for message type: ${t}`);try{const i=Date.now(),a=await s(n,e),u=Date.now()-i;return Pt.debug("Handler completed",{type:t,correlationId:r,duration:`${u}ms`}),u>5e3&&Pt.warn("Slow handler detected",{type:t,correlationId:r,duration:u}),a}catch(i){return Pt.error("Handler error",{type:t,correlationId:r,error:i==null?void 0:i.message,stack:i==null?void 0:i.stack}),he(n,X.UNKNOWN_ERROR,`Handler error: ${(i==null?void 0:i.message)||"Unknown error"}`,{stack:i==null?void 0:i.stack})}}function sl(){return{handlerCount:Dr.size,registeredTypes:Array.from(Dr.keys())}}fe(M.PING,async n=>re(n,M.PONG,{timestamp:Date.now(),stats:sl()}));Pt.info("Message router initialized",sl());const ne=Re("ChatGPTSession");async function Js(n,e,t={}){var a,u;const r=ne.startOperation("sendInput"),s=t.maxRetries??3,i=t.retryDelayMs??2e3;try{if(!n||n<0)return le(X.INVALID_TAB_ID,"Invalid tab ID provided","sendInput");if(!e||typeof e!="string"||e.trim().length===0)return le(X.EMPTY_PROMPT,"Prompt cannot be empty","sendInput");let l=null;for(let d=0;d<=s;d++)try{if(d>0){const m=i*Math.pow(2,d-1);ne.info(`[sendInput] Retry attempt ${d}/${s} after ${m}ms`,{correlationId:r}),await new Promise(I=>setTimeout(I,m))}const f=await chrome.tabs.sendMessage(n,{action:"send_input",prompt:e,createNewChat:t.createNewChat!==!1,runId:t.runId||null,reviewOnly:t.reviewOnly||!1});if(f&&(f.status==="sent"||f.status==="accepted"||f.status==="filled")){const m={chatId:f.chatId||null,chatUrl:f.chatUrl||null,status:f.status};return ne.endOperation(r,"success"),_t(m)}if(l=`Invalid status: ${f==null?void 0:f.status}`,d<s){ne.warn("[sendInput] Invalid status, retrying",{attempt:d+1,status:f==null?void 0:f.status,correlationId:r});continue}}catch(f){if(l=f,(((a=f.message)==null?void 0:a.includes("Receiving end does not exist"))||((u=f.message)==null?void 0:u.includes("Could not establish connection")))&&d<s){ne.warn("[sendInput] Content script not ready, retrying",{attempt:d+1,error:f.message,correlationId:r});continue}throw f}return ne.endOperation(r,"error",`Max retries exhausted: ${l}`),le(X.INPUT_SEND_FAILED,`Failed after ${s+1} attempts`,"sendInput",{lastError:String(l)})}catch(l){return ne.endOperation(r,"error",l),ln(l,"sendInput")}}async function il(n,e={}){const t=ne.startOperation("getOutput"),r=e.maxRetries??3,s=e.retryDelayMs??2e3;let i=null;try{if(!n||n<0)return le(X.INVALID_TAB_ID,"Invalid tab ID provided","getOutput");for(let a=0;a<=r;a++)try{if(a>0){const l=s*Math.pow(2,a-1);ne.info(`[getOutput] Retry attempt ${a}/${r} after ${l}ms delay`,{correlationId:t}),await new Promise(d=>setTimeout(d,l))}const u=await chrome.tabs.sendMessage(n,{action:"get_output",wait:e.wait!==!1,timeoutMs:e.timeoutMs||15*60*1e3,stableMs:e.stableMs||1500});if(u&&u.result){i=u.result;const l={result:u.result,chatId:u.chatId||null,chatUrl:u.chatUrl||null,assistantMessageId:u.assistantMessageId||null,status:u.status||"completed",retryAttempt:a};return ne.endOperation(t,"success",{attempt:a}),_t(l)}if(u&&u.status==="generating"){ne.info("[getOutput] Still generating, will retry",{correlationId:t,attempt:a});continue}if(ne.warn(`[getOutput] No result in response, attempt ${a}/${r}`,{correlationId:t}),a===r)return ne.endOperation(t,"error","No result after retries"),le(X.OUTPUT_FETCH_FAILED,i?`Timeout: partial result available (${i.length} chars)`:"No result available from ChatGPT after retries","getOutput",{responseStatus:u==null?void 0:u.status,attempts:a+1,partialResult:i==null?void 0:i.substring(0,200)})}catch(u){ne.warn(`[getOutput] Attempt ${a} failed:`,{correlationId:t,error:u});const l=(u==null?void 0:u.message)||String(u);if(!(l.includes("Could not establish connection")||l.includes("timeout")||l.includes("rate limit")||l.includes("network"))||a===r)throw u;ne.info("[getOutput] Retryable error detected, will retry",{correlationId:t,attempt:a})}return ne.endOperation(t,"error","Retry loop exhausted"),le(X.OUTPUT_FETCH_FAILED,"Failed to get output after all retries","getOutput",{attempts:r+1})}catch(a){return ne.endOperation(t,"error",a),ln(a,"getOutput")}}async function Hn(n={}){const e=ne.startOperation("ensureChatGPTTab"),t=n.createIfNeeded!==!1,r=n.focusTab!==!1;try{let i=(await chrome.tabs.query({})).find(u=>u.url&&u.url.includes("chatgpt.com"));if(i){if(ne.info("Found existing ChatGPT tab",{tabId:i.id}),r&&await chrome.tabs.update(i.id,{active:!0}),await $i(i.id))return ne.endOperation(e,"success"),{tabId:i.id,isNew:!1};if(t){if(ne.warn("Content script not ready on existing tab, reloading",{tabId:i.id}),await chrome.tabs.reload(i.id),await new Promise(d=>{let f=null;const m=()=>{f&&clearTimeout(f),chrome.tabs.onUpdated.removeListener(I)},I=(S,C)=>{S===i.id&&C.status==="complete"&&(m(),d())};chrome.tabs.onUpdated.addListener(I),f=setTimeout(()=>{m(),d()},3e4)}),await new Promise(d=>setTimeout(d,2e3)),await $i(i.id))return ne.endOperation(e,"success"),{tabId:i.id,isNew:!1};ne.warn("Content script still not ready after reload, creating new tab"),i=null}else{const l="Content script not ready and createIfNeeded=false";return ne.endOperation(e,"error",l),{tabId:i.id,isNew:!1,error:l}}}if(!i&&t){if(ne.info("Creating new ChatGPT tab"),i=await chrome.tabs.create({url:"https://chatgpt.com/",active:r}),await new Promise(l=>{let d=null;const f=()=>{d&&clearTimeout(d),chrome.tabs.onUpdated.removeListener(m)},m=(I,S)=>{I===i.id&&S.status==="complete"&&(f(),l())};chrome.tabs.onUpdated.addListener(m),d=setTimeout(()=>{f(),l()},3e4)}),await new Promise(l=>setTimeout(l,2e3)),await $i(i.id))return ne.endOperation(e,"success"),{tabId:i.id,isNew:!0};{const l="Content script not ready after waiting";return ne.endOperation(e,"error",l),{tabId:i.id,isNew:!0,error:l}}}const a="No ChatGPT tab found";return ne.endOperation(e,"error",a),{tabId:-1,isNew:!1,error:a}}catch(s){const i=(s==null?void 0:s.message)||String(s);return ne.endOperation(e,"error",i),{tabId:-1,isNew:!1,error:i}}}async function $i(n,e={}){const t=e.maxRetries||10,r=e.retryDelay||500;try{await chrome.tabs.get(n)}catch(s){return ne.warn("Tab does not exist",{tabId:n,error:s.message}),!1}for(let s=0;s<t;s++)try{return await chrome.tabs.sendMessage(n,{action:"ping"}),ne.debug("Content script ready",{tabId:n,attempt:s+1}),!0}catch{try{await chrome.tabs.get(n)}catch{return ne.warn("Tab closed during content script check",{tabId:n}),!1}ne.debug("Content script not ready, retrying",{tabId:n,attempt:s+1,maxRetries:t}),s<t-1&&await new Promise(a=>setTimeout(a,r))}return ne.error("Content script not ready after max retries",{tabId:n,maxRetries:t}),!1}const ks=Re("Handlers/ChatGPT");fe(M.CHATGPT_SEND_INPUT,async(n,e)=>{const{prompt:t,options:r={}}=n;ks.info("Handling CHATGPT_SEND_INPUT",{correlationId:n.correlationId,promptLength:t==null?void 0:t.length});const s=await Hn(r);if(s.error)return re(n,M.ERROR,{error:s.error});const i=await Js(s.tabId,t,r);return i.success?re(n,M.CHATGPT_INPUT_SENT,{data:i.data}):re(n,M.ERROR,{error:i.error})});fe(M.CHATGPT_GET_OUTPUT,async(n,e)=>{const{tabId:t,options:r={}}=n.payload||{};ks.info("Handling CHATGPT_GET_OUTPUT",{correlationId:n.correlationId,requestedTabId:t});let s=t;if(!s){const a=await chrome.tabs.query({url:"https://chatgpt.com/*"});if(a.length===0)return re(n,M.ERROR,{error:"No ChatGPT tab found"});s=a[0].id,ks.info("Found ChatGPT tab",{tabId:s})}const i=await il(s,r);return i.success?re(n,M.CHATGPT_OUTPUT_READY,{output:i.data.result,chatId:i.data.chatId,chatUrl:i.data.chatUrl,assistantMessageId:i.data.assistantMessageId,status:i.data.status}):re(n,M.ERROR,{error:i.error})});ks.info("ChatGPT handlers registered");const Pn=Re("Platform/Storage"),ol={LOCAL:"local"};async function If(n=null,e=ol.LOCAL){const t=Pn.startOperation("storageGet");try{const r=chrome.storage[e];if(!r)return le(X.UNKNOWN_ERROR,`Invalid storage area: ${e}`,"storageGet");const s=await r.get(n);return Pn.endOperation(t,"success"),_t(s)}catch(r){return Pn.endOperation(t,"error",r),le(X.UNKNOWN_ERROR,(r==null?void 0:r.message)||"Storage get failed","storageGet",r)}}async function Tf(n,e=ol.LOCAL){const t=Pn.startOperation("storageSet");try{const r=chrome.storage[e];return r?(await r.set(n),Pn.endOperation(t,"success"),_t({keysSet:Object.keys(n).length})):le(X.UNKNOWN_ERROR,`Invalid storage area: ${e}`,"storageSet")}catch(r){return Pn.endOperation(t,"error",r),le(X.UNKNOWN_ERROR,(r==null?void 0:r.message)||"Storage set failed","storageSet",r)}}const bo=Re("Handlers/State");fe(M.STATE_GET,async(n,e)=>{const{keys:t,area:r}=n;bo.info("Handling STATE_GET",{correlationId:n.correlationId,keys:t});const s=await If(t,r);return s.success?re(n,M.STATE_UPDATED,{data:s.data}):re(n,M.ERROR,{error:s.error})});fe(M.STATE_SET,async(n,e)=>{const{items:t,area:r}=n;bo.info("Handling STATE_SET",{correlationId:n.correlationId,keys:Object.keys(t||{})});const s=await Tf(t,r);return s.success?re(n,M.STATE_UPDATED,{data:s.data}):re(n,M.ERROR,{error:s.error})});bo.info("State handlers registered");const ct=Re("Handlers/Portfolio");function wf(n){if(!n||typeof n!="object")return{valid:!1,error:"Entry must be an object"};if(!n.code||typeof n.code!="string"||n.code.trim().length===0)return{valid:!1,error:"Stock code is required and must be a non-empty string"};if(n.quantity!==void 0){const e=Number(n.quantity);if(!Number.isFinite(e)||e<=0)return{valid:!1,error:"Quantity must be a positive number"}}if(n.entryPrice!==void 0){const e=Number(n.entryPrice);if(!Number.isFinite(e)||e<=0)return{valid:!1,error:"Entry price must be a positive number"}}return{valid:!0}}fe(M.PORTFOLIO_ADD,async(n,e)=>{const t=ct.startOperation("portfolioAdd",n.correlationId);try{const{entry:r}=n.payload||{},s=wf(r);if(!s.valid)return ct.endOperation(t,"error",s.error),he(n,X.INVALID_INPUT,s.error);const i=r.code.trim().toUpperCase(),a=await chrome.storage.local.get(["portfolio"]),u=Array.isArray(a.portfolio)?a.portfolio:[];if(u.findIndex(f=>f.code&&f.code.toUpperCase()===i)>=0)return ct.warn("Duplicate stock code",{correlationId:t,stockCode:i}),ct.endOperation(t,"error","Duplicate stock"),he(n,X.INVALID_INPUT,`Stock ${i} already exists in portfolio`);const d={code:i,quantity:r.quantity?Number(r.quantity):0,entryPrice:r.entryPrice?Number(r.entryPrice):0,note:r.note||"",addedAt:Date.now()};return u.push(d),await chrome.storage.local.set({portfolio:u}),ct.info("Portfolio entry added",{correlationId:t,stockCode:i,portfolioSize:u.length}),ct.endOperation(t,"success"),re(n,M.PORTFOLIO_UPDATE,{success:!0,entry:d,portfolioSize:u.length})}catch(r){return ct.error("Portfolio add failed",{correlationId:t,error:r}),ct.endOperation(t,"error",r),he(n,X.OPERATION_FAILED,r.message||"Failed to add portfolio entry")}});ct.info("Portfolio handlers registered");const Af=()=>{};var Sc={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Df(n,e){if(n.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const t={alg:"none",type:"JWT"},r=e||"demo-project",s=n.iat||0,i=n.sub||n.user_id;if(!i)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const a={iss:`https://securetoken.google.com/${r}`,aud:r,iat:s,exp:s+3600,auth_time:s,sub:i,user_id:i,firebase:{sign_in_provider:"custom",identities:{}},...n};return[Ds(JSON.stringify(t)),Ds(JSON.stringify(a)),""].join(".")}const Rr={};function Vf(){const n={prod:[],emulator:[]};for(const e of Object.keys(Rr))Rr[e]?n.emulator.push(e):n.prod.push(e);return n}function Lf(n){let e=document.getElementById(n),t=!1;return e||(e=document.createElement("div"),e.setAttribute("id",n),t=!0),{created:t,element:e}}let Pc=!1;function pl(n,e){if(typeof window>"u"||typeof document>"u"||!jn(window.location.host)||Rr[n]===e||Rr[n]||Pc)return;Rr[n]=e;function t(I){return`__firebase__banner__${I}`}const r="__firebase__banner",i=Vf().prod.length>0;function a(){const I=document.getElementById(r);I&&I.remove()}function u(I){I.style.display="flex",I.style.background="#7faaf0",I.style.position="fixed",I.style.bottom="5px",I.style.left="5px",I.style.padding=".5em",I.style.borderRadius="5px",I.style.alignItems="center"}function l(I,S){I.setAttribute("width","24"),I.setAttribute("id",S),I.setAttribute("height","24"),I.setAttribute("viewBox","0 0 24 24"),I.setAttribute("fill","none"),I.style.marginLeft="-6px"}function d(){const I=document.createElement("span");return I.style.cursor="pointer",I.style.marginLeft="16px",I.style.fontSize="24px",I.innerHTML=" &times;",I.onclick=()=>{Pc=!0,a()},I}function f(I,S){I.setAttribute("id",S),I.innerText="Learn more",I.href="https://firebase.google.com/docs/studio/preview-apps#preview-backend",I.setAttribute("target","__blank"),I.style.paddingLeft="5px",I.style.textDecoration="underline"}function m(){const I=Lf(r),S=t("text"),C=document.getElementById(S)||document.createElement("span"),D=t("learnmore"),N=document.getElementById(D)||document.createElement("a"),F=t("preprendIcon"),L=document.getElementById(F)||document.createElementNS("http://www.w3.org/2000/svg","svg");if(I.created){const U=I.element;u(U),f(N,D);const Y=d();l(L,F),U.append(L,C,N,Y),document.body.appendChild(U)}i?(C.innerText="Preview backend disconnected.",L.innerHTML=`<g clip-path="url(#clip0_6013_33858)">
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zf="FirebaseError";class yt extends Error{constructor(e,t,r){super(t),this.code=e,this.customData=r,this.name=zf,Object.setPrototypeOf(this,yt.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,zr.prototype.create)}}class zr{constructor(e,t,r){this.service=e,this.serviceName=t,this.errors=r}create(e,...t){const r=t[0]||{},s=`${this.service}/${e}`,i=this.errors[e],a=i?Gf(i,r):"Error",u=`${this.serviceName}: ${a} (${s}).`;return new yt(s,u,r)}}function Gf(n,e){return n.replace(Wf,(t,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const Wf=/\{\$([^}]+)}/g;function Kf(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}function rn(n,e){if(n===e)return!0;const t=Object.keys(n),r=Object.keys(e);for(const s of t){if(!r.includes(s))return!1;const i=n[s],a=e[s];if(bc(i)&&bc(a)){if(!rn(i,a))return!1}else if(i!==a)return!1}for(const s of r)if(!t.includes(s))return!1;return!0}function bc(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yp="firebase-heartbeat-database",Xp=1,Vr="firebase-heartbeat-store";let Wi=null;function El(){return Wi||(Wi=pp(Yp,Xp,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Vr)}catch(t){console.warn(t)}}}}).catch(n=>{throw Vt.create("idb-open",{originalErrorMessage:n.message})})),Wi}async function Jp(n){try{const t=(await El()).transaction(Vr),r=await t.objectStore(Vr).get(Il(n));return await t.done,r}catch(e){if(e instanceof yt)ft.warn(e.message);else{const t=Vt.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});ft.warn(t.message)}}}async function Vc(n,e){try{const r=(await El()).transaction(Vr,"readwrite");await r.objectStore(Vr).put(e,Il(n)),await r.done}catch(t){if(t instanceof yt)ft.warn(t.message);else{const r=Vt.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});ft.warn(r.message)}}}function Il(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var Mt,Tl;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(E,g){function y(){}y.prototype=g.prototype,E.F=g.prototype,E.prototype=new y,E.prototype.constructor=E,E.D=function(w,T,v){for(var _=Array(arguments.length-2),Fe=2;Fe<arguments.length;Fe++)_[Fe-2]=arguments[Fe];return g.prototype[T].apply(w,_)}}function t(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(r,t),r.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(E,g,y){y||(y=0);const w=Array(16);if(typeof g=="string")for(var T=0;T<16;++T)w[T]=g.charCodeAt(y++)|g.charCodeAt(y++)<<8|g.charCodeAt(y++)<<16|g.charCodeAt(y++)<<24;else for(T=0;T<16;++T)w[T]=g[y++]|g[y++]<<8|g[y++]<<16|g[y++]<<24;g=E.g[0],y=E.g[1],T=E.g[2];let v=E.g[3],_;_=g+(v^y&(T^v))+w[0]+3614090360&4294967295,g=y+(_<<7&4294967295|_>>>25),_=v+(T^g&(y^T))+w[1]+3905402710&4294967295,v=g+(_<<12&4294967295|_>>>20),_=T+(y^v&(g^y))+w[2]+606105819&4294967295,T=v+(_<<17&4294967295|_>>>15),_=y+(g^T&(v^g))+w[3]+3250441966&4294967295,y=T+(_<<22&4294967295|_>>>10),_=g+(v^y&(T^v))+w[4]+4118548399&4294967295,g=y+(_<<7&4294967295|_>>>25),_=v+(T^g&(y^T))+w[5]+1200080426&4294967295,v=g+(_<<12&4294967295|_>>>20),_=T+(y^v&(g^y))+w[6]+2821735955&4294967295,T=v+(_<<17&4294967295|_>>>15),_=y+(g^T&(v^g))+w[7]+4249261313&4294967295,y=T+(_<<22&4294967295|_>>>10),_=g+(v^y&(T^v))+w[8]+1770035416&4294967295,g=y+(_<<7&4294967295|_>>>25),_=v+(T^g&(y^T))+w[9]+2336552879&4294967295,v=g+(_<<12&4294967295|_>>>20),_=T+(y^v&(g^y))+w[10]+4294925233&4294967295,T=v+(_<<17&4294967295|_>>>15),_=y+(g^T&(v^g))+w[11]+2304563134&4294967295,y=T+(_<<22&4294967295|_>>>10),_=g+(v^y&(T^v))+w[12]+1804603682&4294967295,g=y+(_<<7&4294967295|_>>>25),_=v+(T^g&(y^T))+w[13]+4254626195&4294967295,v=g+(_<<12&4294967295|_>>>20),_=T+(y^v&(g^y))+w[14]+2792965006&4294967295,T=v+(_<<17&4294967295|_>>>15),_=y+(g^T&(v^g))+w[15]+1236535329&4294967295,y=T+(_<<22&4294967295|_>>>10),_=g+(T^v&(y^T))+w[1]+4129170786&4294967295,g=y+(_<<5&4294967295|_>>>27),_=v+(y^T&(g^y))+w[6]+3225465664&4294967295,v=g+(_<<9&4294967295|_>>>23),_=T+(g^y&(v^g))+w[11]+643717713&4294967295,T=v+(_<<14&4294967295|_>>>18),_=y+(v^g&(T^v))+w[0]+3921069994&4294967295,y=T+(_<<20&4294967295|_>>>12),_=g+(T^v&(y^T))+w[5]+3593408605&4294967295,g=y+(_<<5&4294967295|_>>>27),_=v+(y^T&(g^y))+w[10]+38016083&4294967295,v=g+(_<<9&4294967295|_>>>23),_=T+(g^y&(v^g))+w[15]+3634488961&4294967295,T=v+(_<<14&4294967295|_>>>18),_=y+(v^g&(T^v))+w[4]+3889429448&4294967295,y=T+(_<<20&4294967295|_>>>12),_=g+(T^v&(y^T))+w[9]+568446438&4294967295,g=y+(_<<5&4294967295|_>>>27),_=v+(y^T&(g^y))+w[14]+3275163606&4294967295,v=g+(_<<9&4294967295|_>>>23),_=T+(g^y&(v^g))+w[3]+4107603335&4294967295,T=v+(_<<14&4294967295|_>>>18),_=y+(v^g&(T^v))+w[8]+1163531501&4294967295,y=T+(_<<20&4294967295|_>>>12),_=g+(T^v&(y^T))+w[13]+2850285829&4294967295,g=y+(_<<5&4294967295|_>>>27),_=v+(y^T&(g^y))+w[2]+4243563512&4294967295,v=g+(_<<9&4294967295|_>>>23),_=T+(g^y&(v^g))+w[7]+1735328473&4294967295,T=v+(_<<14&4294967295|_>>>18),_=y+(v^g&(T^v))+w[12]+2368359562&4294967295,y=T+(_<<20&4294967295|_>>>12),_=g+(y^T^v)+w[5]+4294588738&4294967295,g=y+(_<<4&4294967295|_>>>28),_=v+(g^y^T)+w[8]+2272392833&4294967295,v=g+(_<<11&4294967295|_>>>21),_=T+(v^g^y)+w[11]+1839030562&4294967295,T=v+(_<<16&4294967295|_>>>16),_=y+(T^v^g)+w[14]+4259657740&4294967295,y=T+(_<<23&4294967295|_>>>9),_=g+(y^T^v)+w[1]+2763975236&4294967295,g=y+(_<<4&4294967295|_>>>28),_=v+(g^y^T)+w[4]+1272893353&4294967295,v=g+(_<<11&4294967295|_>>>21),_=T+(v^g^y)+w[7]+4139469664&4294967295,T=v+(_<<16&4294967295|_>>>16),_=y+(T^v^g)+w[10]+3200236656&4294967295,y=T+(_<<23&4294967295|_>>>9),_=g+(y^T^v)+w[13]+681279174&4294967295,g=y+(_<<4&4294967295|_>>>28),_=v+(g^y^T)+w[0]+3936430074&4294967295,v=g+(_<<11&4294967295|_>>>21),_=T+(v^g^y)+w[3]+3572445317&4294967295,T=v+(_<<16&4294967295|_>>>16),_=y+(T^v^g)+w[6]+76029189&4294967295,y=T+(_<<23&4294967295|_>>>9),_=g+(y^T^v)+w[9]+3654602809&4294967295,g=y+(_<<4&4294967295|_>>>28),_=v+(g^y^T)+w[12]+3873151461&4294967295,v=g+(_<<11&4294967295|_>>>21),_=T+(v^g^y)+w[15]+530742520&4294967295,T=v+(_<<16&4294967295|_>>>16),_=y+(T^v^g)+w[2]+3299628645&4294967295,y=T+(_<<23&4294967295|_>>>9),_=g+(T^(y|~v))+w[0]+4096336452&4294967295,g=y+(_<<6&4294967295|_>>>26),_=v+(y^(g|~T))+w[7]+1126891415&4294967295,v=g+(_<<10&4294967295|_>>>22),_=T+(g^(v|~y))+w[14]+2878612391&4294967295,T=v+(_<<15&4294967295|_>>>17),_=y+(v^(T|~g))+w[5]+4237533241&4294967295,y=T+(_<<21&4294967295|_>>>11),_=g+(T^(y|~v))+w[12]+1700485571&4294967295,g=y+(_<<6&4294967295|_>>>26),_=v+(y^(g|~T))+w[3]+2399980690&4294967295,v=g+(_<<10&4294967295|_>>>22),_=T+(g^(v|~y))+w[10]+4293915773&4294967295,T=v+(_<<15&4294967295|_>>>17),_=y+(v^(T|~g))+w[1]+2240044497&4294967295,y=T+(_<<21&4294967295|_>>>11),_=g+(T^(y|~v))+w[8]+1873313359&4294967295,g=y+(_<<6&4294967295|_>>>26),_=v+(y^(g|~T))+w[15]+4264355552&4294967295,v=g+(_<<10&4294967295|_>>>22),_=T+(g^(v|~y))+w[6]+2734768916&4294967295,T=v+(_<<15&4294967295|_>>>17),_=y+(v^(T|~g))+w[13]+1309151649&4294967295,y=T+(_<<21&4294967295|_>>>11),_=g+(T^(y|~v))+w[4]+4149444226&4294967295,g=y+(_<<6&4294967295|_>>>26),_=v+(y^(g|~T))+w[11]+3174756917&4294967295,v=g+(_<<10&4294967295|_>>>22),_=T+(g^(v|~y))+w[2]+718787259&4294967295,T=v+(_<<15&4294967295|_>>>17),_=y+(v^(T|~g))+w[9]+3951481745&4294967295,E.g[0]=E.g[0]+g&4294967295,E.g[1]=E.g[1]+(T+(_<<21&4294967295|_>>>11))&4294967295,E.g[2]=E.g[2]+T&4294967295,E.g[3]=E.g[3]+v&4294967295}r.prototype.v=function(E,g){g===void 0&&(g=E.length);const y=g-this.blockSize,w=this.C;let T=this.h,v=0;for(;v<g;){if(T==0)for(;v<=y;)s(this,E,v),v+=this.blockSize;if(typeof E=="string"){for(;v<g;)if(w[T++]=E.charCodeAt(v++),T==this.blockSize){s(this,w),T=0;break}}else for(;v<g;)if(w[T++]=E[v++],T==this.blockSize){s(this,w),T=0;break}}this.h=T,this.o+=g},r.prototype.A=function(){var E=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);E[0]=128;for(var g=1;g<E.length-8;++g)E[g]=0;g=this.o*8;for(var y=E.length-8;y<E.length;++y)E[y]=g&255,g/=256;for(this.v(E),E=Array(16),g=0,y=0;y<4;++y)for(let w=0;w<32;w+=8)E[g++]=this.g[y]>>>w&255;return E};function i(E,g){var y=u;return Object.prototype.hasOwnProperty.call(y,E)?y[E]:y[E]=g(E)}function a(E,g){this.h=g;const y=[];let w=!0;for(let T=E.length-1;T>=0;T--){const v=E[T]|0;w&&v==g||(y[T]=v,w=!1)}this.g=y}var u={};function l(E){return-128<=E&&E<128?i(E,function(g){return new a([g|0],g<0?-1:0)}):new a([E|0],E<0?-1:0)}function d(E){if(isNaN(E)||!isFinite(E))return m;if(E<0)return N(d(-E));const g=[];let y=1;for(let w=0;E>=y;w++)g[w]=E/y|0,y*=4294967296;return new a(g,0)}function f(E,g){if(E.length==0)throw Error("number format error: empty string");if(g=g||10,g<2||36<g)throw Error("radix out of range: "+g);if(E.charAt(0)=="-")return N(f(E.substring(1),g));if(E.indexOf("-")>=0)throw Error('number format error: interior "-" character');const y=d(Math.pow(g,8));let w=m;for(let v=0;v<E.length;v+=8){var T=Math.min(8,E.length-v);const _=parseInt(E.substring(v,v+T),g);T<8?(T=d(Math.pow(g,T)),w=w.j(T).add(d(_))):(w=w.j(y),w=w.add(d(_)))}return w}var m=l(0),I=l(1),S=l(16777216);n=a.prototype,n.m=function(){if(D(this))return-N(this).m();let E=0,g=1;for(let y=0;y<this.g.length;y++){const w=this.i(y);E+=(w>=0?w:4294967296+w)*g,g*=4294967296}return E},n.toString=function(E){if(E=E||10,E<2||36<E)throw Error("radix out of range: "+E);if(C(this))return"0";if(D(this))return"-"+N(this).toString(E);const g=d(Math.pow(E,6));var y=this;let w="";for(;;){const T=Y(y,g).g;y=F(y,T.j(g));let v=((y.g.length>0?y.g[0]:y.h)>>>0).toString(E);if(y=T,C(y))return v+w;for(;v.length<6;)v="0"+v;w=v+w}},n.i=function(E){return E<0?0:E<this.g.length?this.g[E]:this.h};function C(E){if(E.h!=0)return!1;for(let g=0;g<E.g.length;g++)if(E.g[g]!=0)return!1;return!0}function D(E){return E.h==-1}n.l=function(E){return E=F(this,E),D(E)?-1:C(E)?0:1};function N(E){const g=E.g.length,y=[];for(let w=0;w<g;w++)y[w]=~E.g[w];return new a(y,~E.h).add(I)}n.abs=function(){return D(this)?N(this):this},n.add=function(E){const g=Math.max(this.g.length,E.g.length),y=[];let w=0;for(let T=0;T<=g;T++){let v=w+(this.i(T)&65535)+(E.i(T)&65535),_=(v>>>16)+(this.i(T)>>>16)+(E.i(T)>>>16);w=_>>>16,v&=65535,_&=65535,y[T]=_<<16|v}return new a(y,y[y.length-1]&-2147483648?-1:0)};function F(E,g){return E.add(N(g))}n.j=function(E){if(C(this)||C(E))return m;if(D(this))return D(E)?N(this).j(N(E)):N(N(this).j(E));if(D(E))return N(this.j(N(E)));if(this.l(S)<0&&E.l(S)<0)return d(this.m()*E.m());const g=this.g.length+E.g.length,y=[];for(var w=0;w<2*g;w++)y[w]=0;for(w=0;w<this.g.length;w++)for(let T=0;T<E.g.length;T++){const v=this.i(w)>>>16,_=this.i(w)&65535,Fe=E.i(T)>>>16,Wt=E.i(T)&65535;y[2*w+2*T]+=_*Wt,L(y,2*w+2*T),y[2*w+2*T+1]+=v*Wt,L(y,2*w+2*T+1),y[2*w+2*T+1]+=_*Fe,L(y,2*w+2*T+1),y[2*w+2*T+2]+=v*Fe,L(y,2*w+2*T+2)}for(E=0;E<g;E++)y[E]=y[2*E+1]<<16|y[2*E];for(E=g;E<2*g;E++)y[E]=0;return new a(y,0)};function L(E,g){for(;(E[g]&65535)!=E[g];)E[g+1]+=E[g]>>>16,E[g]&=65535,g++}function U(E,g){this.g=E,this.h=g}function Y(E,g){if(C(g))throw Error("division by zero");if(C(E))return new U(m,m);if(D(E))return g=Y(N(E),g),new U(N(g.g),N(g.h));if(D(g))return g=Y(E,N(g)),new U(N(g.g),g.h);if(E.g.length>30){if(D(E)||D(g))throw Error("slowDivide_ only works with positive integers.");for(var y=I,w=g;w.l(E)<=0;)y=K(y),w=K(w);var T=Q(y,1),v=Q(w,1);for(w=Q(w,2),y=Q(y,2);!C(w);){var _=v.add(w);_.l(E)<=0&&(T=T.add(y),v=_),w=Q(w,1),y=Q(y,1)}return g=F(E,T.j(g)),new U(T,g)}for(T=m;E.l(g)>=0;){for(y=Math.max(1,Math.floor(E.m()/g.m())),w=Math.ceil(Math.log(y)/Math.LN2),w=w<=48?1:Math.pow(2,w-48),v=d(y),_=v.j(g);D(_)||_.l(E)>0;)y-=w,v=d(y),_=v.j(g);C(v)&&(v=I),T=T.add(v),E=F(E,_)}return new U(T,E)}n.B=function(E){return Y(this,E).h},n.and=function(E){const g=Math.max(this.g.length,E.g.length),y=[];for(let w=0;w<g;w++)y[w]=this.i(w)&E.i(w);return new a(y,this.h&E.h)},n.or=function(E){const g=Math.max(this.g.length,E.g.length),y=[];for(let w=0;w<g;w++)y[w]=this.i(w)|E.i(w);return new a(y,this.h|E.h)},n.xor=function(E){const g=Math.max(this.g.length,E.g.length),y=[];for(let w=0;w<g;w++)y[w]=this.i(w)^E.i(w);return new a(y,this.h^E.h)};function K(E){const g=E.g.length+1,y=[];for(let w=0;w<g;w++)y[w]=E.i(w)<<1|E.i(w-1)>>>31;return new a(y,E.h)}function Q(E,g){const y=g>>5;g%=32;const w=E.g.length-y,T=[];for(let v=0;v<w;v++)T[v]=g>0?E.i(v+y)>>>g|E.i(v+y+1)<<32-g:E.i(v+y);return new a(T,E.h)}r.prototype.digest=r.prototype.A,r.prototype.reset=r.prototype.u,r.prototype.update=r.prototype.v,Tl=r,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.B,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=d,a.fromString=f,Mt=a}).apply(typeof xc<"u"?xc:typeof self<"u"?self:typeof window<"u"?window:{});var gs=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var wl,Ir,Al,ws,co,vl,Rl,Sl;(function(){var n,e=Object.defineProperty;function t(o){o=[typeof globalThis=="object"&&globalThis,o,typeof window=="object"&&window,typeof self=="object"&&self,typeof gs=="object"&&gs];for(var c=0;c<o.length;++c){var h=o[c];if(h&&h.Math==Math)return h}throw Error("Cannot find global object")}var r=t(this);function s(o,c){if(c)e:{var h=r;o=o.split(".");for(var p=0;p<o.length-1;p++){var A=o[p];if(!(A in h))break e;h=h[A]}o=o[o.length-1],p=h[o],c=c(p),c!=p&&c!=null&&e(h,o,{configurable:!0,writable:!0,value:c})}}s("Symbol.dispose",function(o){return o||Symbol("Symbol.dispose")}),s("Array.prototype.values",function(o){return o||function(){return this[Symbol.iterator]()}}),s("Object.entries",function(o){return o||function(c){var h=[],p;for(p in c)Object.prototype.hasOwnProperty.call(c,p)&&h.push([p,c[p]]);return h}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var i=i||{},a=this||self;function u(o){var c=typeof o;return c=="object"&&o!=null||c=="function"}function l(o,c,h){return o.call.apply(o.bind,arguments)}function d(o,c,h){return d=l,d.apply(null,arguments)}function f(o,c){var h=Array.prototype.slice.call(arguments,1);return function(){var p=h.slice();return p.push.apply(p,arguments),o.apply(this,p)}}function m(o,c){function h(){}h.prototype=c.prototype,o.Z=c.prototype,o.prototype=new h,o.prototype.constructor=o,o.Ob=function(p,A,R){for(var O=Array(arguments.length-2),z=2;z<arguments.length;z++)O[z-2]=arguments[z];return c.prototype[A].apply(p,O)}}var I=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?o=>o&&AsyncContext.Snapshot.wrap(o):o=>o;function S(o){const c=o.length;if(c>0){const h=Array(c);for(let p=0;p<c;p++)h[p]=o[p];return h}return[]}function C(o,c){for(let p=1;p<arguments.length;p++){const A=arguments[p];var h=typeof A;if(h=h!="object"?h:A?Array.isArray(A)?"array":h:"null",h=="array"||h=="object"&&typeof A.length=="number"){h=o.length||0;const R=A.length||0;o.length=h+R;for(let O=0;O<R;O++)o[h+O]=A[O]}else o.push(A)}}class D{constructor(c,h){this.i=c,this.j=h,this.h=0,this.g=null}get(){let c;return this.h>0?(this.h--,c=this.g,this.g=c.next,c.next=null):c=this.i(),c}}function N(o){a.setTimeout(()=>{throw o},0)}function F(){var o=E;let c=null;return o.g&&(c=o.g,o.g=o.g.next,o.g||(o.h=null),c.next=null),c}class L{constructor(){this.h=this.g=null}add(c,h){const p=U.get();p.set(c,h),this.h?this.h.next=p:this.g=p,this.h=p}}var U=new D(()=>new Y,o=>o.reset());class Y{constructor(){this.next=this.g=this.h=null}set(c,h){this.h=c,this.g=h,this.next=null}reset(){this.next=this.g=this.h=null}}let K,Q=!1,E=new L,g=()=>{const o=Promise.resolve(void 0);K=()=>{o.then(y)}};function y(){for(var o;o=F();){try{o.h.call(o.g)}catch(h){N(h)}var c=U;c.j(o),c.h<100&&(c.h++,o.next=c.g,c.g=o)}Q=!1}function w(){this.u=this.u,this.C=this.C}w.prototype.u=!1,w.prototype.dispose=function(){this.u||(this.u=!0,this.N())},w.prototype[Symbol.dispose]=function(){this.dispose()},w.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function T(o,c){this.type=o,this.g=this.target=c,this.defaultPrevented=!1}T.prototype.h=function(){this.defaultPrevented=!0};var v=function(){if(!a.addEventListener||!Object.defineProperty)return!1;var o=!1,c=Object.defineProperty({},"passive",{get:function(){o=!0}});try{const h=()=>{};a.addEventListener("test",h,c),a.removeEventListener("test",h,c)}catch{}return o}();function _(o){return/^[\s\xa0]*$/.test(o)}function Fe(o,c){T.call(this,o?o.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,o&&this.init(o,c)}m(Fe,T),Fe.prototype.init=function(o,c){const h=this.type=o.type,p=o.changedTouches&&o.changedTouches.length?o.changedTouches[0]:null;this.target=o.target||o.srcElement,this.g=c,c=o.relatedTarget,c||(h=="mouseover"?c=o.fromElement:h=="mouseout"&&(c=o.toElement)),this.relatedTarget=c,p?(this.clientX=p.clientX!==void 0?p.clientX:p.pageX,this.clientY=p.clientY!==void 0?p.clientY:p.pageY,this.screenX=p.screenX||0,this.screenY=p.screenY||0):(this.clientX=o.clientX!==void 0?o.clientX:o.pageX,this.clientY=o.clientY!==void 0?o.clientY:o.pageY,this.screenX=o.screenX||0,this.screenY=o.screenY||0),this.button=o.button,this.key=o.key||"",this.ctrlKey=o.ctrlKey,this.altKey=o.altKey,this.shiftKey=o.shiftKey,this.metaKey=o.metaKey,this.pointerId=o.pointerId||0,this.pointerType=o.pointerType,this.state=o.state,this.i=o,o.defaultPrevented&&Fe.Z.h.call(this)},Fe.prototype.h=function(){Fe.Z.h.call(this);const o=this.i;o.preventDefault?o.preventDefault():o.returnValue=!1};var Wt="closure_listenable_"+(Math.random()*1e6|0),Fd=0;function Ud(o,c,h,p,A){this.listener=o,this.proxy=null,this.src=c,this.type=h,this.capture=!!p,this.ha=A,this.key=++Fd,this.da=this.fa=!1}function ts(o){o.da=!0,o.listener=null,o.proxy=null,o.src=null,o.ha=null}function ns(o,c,h){for(const p in o)c.call(h,o[p],p,o)}function Bd(o,c){for(const h in o)c.call(void 0,o[h],h,o)}function Ra(o){const c={};for(const h in o)c[h]=o[h];return c}const Sa="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function Pa(o,c){let h,p;for(let A=1;A<arguments.length;A++){p=arguments[A];for(h in p)o[h]=p[h];for(let R=0;R<Sa.length;R++)h=Sa[R],Object.prototype.hasOwnProperty.call(p,h)&&(o[h]=p[h])}}function rs(o){this.src=o,this.g={},this.h=0}rs.prototype.add=function(o,c,h,p,A){const R=o.toString();o=this.g[R],o||(o=this.g[R]=[],this.h++);const O=Ei(o,c,p,A);return O>-1?(c=o[O],h||(c.fa=!1)):(c=new Ud(c,this.src,R,!!p,A),c.fa=h,o.push(c)),c};function yi(o,c){const h=c.type;if(h in o.g){var p=o.g[h],A=Array.prototype.indexOf.call(p,c,void 0),R;(R=A>=0)&&Array.prototype.splice.call(p,A,1),R&&(ts(c),o.g[h].length==0&&(delete o.g[h],o.h--))}}function Ei(o,c,h,p){for(let A=0;A<o.length;++A){const R=o[A];if(!R.da&&R.listener==c&&R.capture==!!h&&R.ha==p)return A}return-1}var Ii="closure_lm_"+(Math.random()*1e6|0),Ti={};function ba(o,c,h,p,A){if(Array.isArray(c)){for(let R=0;R<c.length;R++)ba(o,c[R],h,p,A);return null}return h=Na(h),o&&o[Wt]?o.J(c,h,u(p)?!!p.capture:!1,A):qd(o,c,h,!1,p,A)}function qd(o,c,h,p,A,R){if(!c)throw Error("Invalid event type");const O=u(A)?!!A.capture:!!A;let z=Ai(o);if(z||(o[Ii]=z=new rs(o)),h=z.add(c,h,p,O,R),h.proxy)return h;if(p=$d(),h.proxy=p,p.src=o,p.listener=h,o.addEventListener)v||(A=O),A===void 0&&(A=!1),o.addEventListener(c.toString(),p,A);else if(o.attachEvent)o.attachEvent(Oa(c.toString()),p);else if(o.addListener&&o.removeListener)o.addListener(p);else throw Error("addEventListener and attachEvent are unavailable.");return h}function $d(){function o(h){return c.call(o.src,o.listener,h)}const c=Hd;return o}function Ca(o,c,h,p,A){if(Array.isArray(c))for(var R=0;R<c.length;R++)Ca(o,c[R],h,p,A);else p=u(p)?!!p.capture:!!p,h=Na(h),o&&o[Wt]?(o=o.i,R=String(c).toString(),R in o.g&&(c=o.g[R],h=Ei(c,h,p,A),h>-1&&(ts(c[h]),Array.prototype.splice.call(c,h,1),c.length==0&&(delete o.g[R],o.h--)))):o&&(o=Ai(o))&&(c=o.g[c.toString()],o=-1,c&&(o=Ei(c,h,p,A)),(h=o>-1?c[o]:null)&&wi(h))}function wi(o){if(typeof o!="number"&&o&&!o.da){var c=o.src;if(c&&c[Wt])yi(c.i,o);else{var h=o.type,p=o.proxy;c.removeEventListener?c.removeEventListener(h,p,o.capture):c.detachEvent?c.detachEvent(Oa(h),p):c.addListener&&c.removeListener&&c.removeListener(p),(h=Ai(c))?(yi(h,o),h.h==0&&(h.src=null,c[Ii]=null)):ts(o)}}}function Oa(o){return o in Ti?Ti[o]:Ti[o]="on"+o}function Hd(o,c){if(o.da)o=!0;else{c=new Fe(c,this);const h=o.listener,p=o.ha||o.src;o.fa&&wi(o),o=h.call(p,c)}return o}function Ai(o){return o=o[Ii],o instanceof rs?o:null}var vi="__closure_events_fn_"+(Math.random()*1e9>>>0);function Na(o){return typeof o=="function"?o:(o[vi]||(o[vi]=function(c){return o.handleEvent(c)}),o[vi])}function Ce(){w.call(this),this.i=new rs(this),this.M=this,this.G=null}m(Ce,w),Ce.prototype[Wt]=!0,Ce.prototype.removeEventListener=function(o,c,h,p){Ca(this,o,c,h,p)};function Me(o,c){var h,p=o.G;if(p)for(h=[];p;p=p.G)h.push(p);if(o=o.M,p=c.type||c,typeof c=="string")c=new T(c,o);else if(c instanceof T)c.target=c.target||o;else{var A=c;c=new T(p,o),Pa(c,A)}A=!0;let R,O;if(h)for(O=h.length-1;O>=0;O--)R=c.g=h[O],A=ss(R,p,!0,c)&&A;if(R=c.g=o,A=ss(R,p,!0,c)&&A,A=ss(R,p,!1,c)&&A,h)for(O=0;O<h.length;O++)R=c.g=h[O],A=ss(R,p,!1,c)&&A}Ce.prototype.N=function(){if(Ce.Z.N.call(this),this.i){var o=this.i;for(const c in o.g){const h=o.g[c];for(let p=0;p<h.length;p++)ts(h[p]);delete o.g[c],o.h--}}this.G=null},Ce.prototype.J=function(o,c,h,p){return this.i.add(String(o),c,!1,h,p)},Ce.prototype.K=function(o,c,h,p){return this.i.add(String(o),c,!0,h,p)};function ss(o,c,h,p){if(c=o.i.g[String(c)],!c)return!0;c=c.concat();let A=!0;for(let R=0;R<c.length;++R){const O=c[R];if(O&&!O.da&&O.capture==h){const z=O.listener,Te=O.ha||O.src;O.fa&&yi(o.i,O),A=z.call(Te,p)!==!1&&A}}return A&&!p.defaultPrevented}function jd(o,c){if(typeof o!="function")if(o&&typeof o.handleEvent=="function")o=d(o.handleEvent,o);else throw Error("Invalid listener argument");return Number(c)>2147483647?-1:a.setTimeout(o,c||0)}function ka(o){o.g=jd(()=>{o.g=null,o.i&&(o.i=!1,ka(o))},o.l);const c=o.h;o.h=null,o.m.apply(null,c)}class zd extends w{constructor(c,h){super(),this.m=c,this.l=h,this.h=null,this.i=!1,this.g=null}j(c){this.h=arguments,this.g?this.i=!0:ka(this)}N(){super.N(),this.g&&(a.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function tr(o){w.call(this),this.h=o,this.g={}}m(tr,w);var Da=[];function Va(o){ns(o.g,function(c,h){this.g.hasOwnProperty(h)&&wi(c)},o),o.g={}}tr.prototype.N=function(){tr.Z.N.call(this),Va(this)},tr.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Ri=a.JSON.stringify,Gd=a.JSON.parse,Wd=class{stringify(o){return a.JSON.stringify(o,void 0)}parse(o){return a.JSON.parse(o,void 0)}};function La(){}function Ma(){}var nr={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function Si(){T.call(this,"d")}m(Si,T);function Pi(){T.call(this,"c")}m(Pi,T);var Kt={},xa=null;function is(){return xa=xa||new Ce}Kt.Ia="serverreachability";function Fa(o){T.call(this,Kt.Ia,o)}m(Fa,T);function rr(o){const c=is();Me(c,new Fa(c))}Kt.STAT_EVENT="statevent";function Ua(o,c){T.call(this,Kt.STAT_EVENT,o),this.stat=c}m(Ua,T);function xe(o){const c=is();Me(c,new Ua(c,o))}Kt.Ja="timingevent";function Ba(o,c){T.call(this,Kt.Ja,o),this.size=c}m(Ba,T);function sr(o,c){if(typeof o!="function")throw Error("Fn must not be null and must be a function");return a.setTimeout(function(){o()},c)}function ir(){this.g=!0}ir.prototype.ua=function(){this.g=!1};function Kd(o,c,h,p,A,R){o.info(function(){if(o.g)if(R){var O="",z=R.split("&");for(let ie=0;ie<z.length;ie++){var Te=z[ie].split("=");if(Te.length>1){const Ae=Te[0];Te=Te[1];const Ze=Ae.split("_");O=Ze.length>=2&&Ze[1]=="type"?O+(Ae+"="+Te+"&"):O+(Ae+"=redacted&")}}}else O=null;else O=R;return"XMLHTTP REQ ("+p+") [attempt "+A+"]: "+c+`
`+h+`
`+O})}function Qd(o,c,h,p,A,R,O){o.info(function(){return"XMLHTTP RESP ("+p+") [ attempt "+A+"]: "+c+`
`+h+`
`+R+" "+O})}function gn(o,c,h,p){o.info(function(){return"XMLHTTP TEXT ("+c+"): "+Xd(o,h)+(p?" "+p:"")})}function Yd(o,c){o.info(function(){return"TIMEOUT: "+c})}ir.prototype.info=function(){};function Xd(o,c){if(!o.g)return c;if(!c)return null;try{const R=JSON.parse(c);if(R){for(o=0;o<R.length;o++)if(Array.isArray(R[o])){var h=R[o];if(!(h.length<2)){var p=h[1];if(Array.isArray(p)&&!(p.length<1)){var A=p[0];if(A!="noop"&&A!="stop"&&A!="close")for(let O=1;O<p.length;O++)p[O]=""}}}}return Ri(R)}catch{return c}}var os={NO_ERROR:0,cb:1,qb:2,pb:3,kb:4,ob:5,rb:6,Ga:7,TIMEOUT:8,ub:9},qa={ib:"complete",Fb:"success",ERROR:"error",Ga:"abort",xb:"ready",yb:"readystatechange",TIMEOUT:"timeout",sb:"incrementaldata",wb:"progress",lb:"downloadprogress",Nb:"uploadprogress"},$a;function bi(){}m(bi,La),bi.prototype.g=function(){return new XMLHttpRequest},$a=new bi;function or(o){return encodeURIComponent(String(o))}function Jd(o){var c=1;o=o.split(":");const h=[];for(;c>0&&o.length;)h.push(o.shift()),c--;return o.length&&h.push(o.join(":")),h}function Et(o,c,h,p){this.j=o,this.i=c,this.l=h,this.S=p||1,this.V=new tr(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new Ha}function Ha(){this.i=null,this.g="",this.h=!1}var ja={},Ci={};function Oi(o,c,h){o.M=1,o.A=cs(Je(c)),o.u=h,o.R=!0,za(o,null)}function za(o,c){o.F=Date.now(),as(o),o.B=Je(o.A);var h=o.B,p=o.S;Array.isArray(p)||(p=[String(p)]),sc(h.i,"t",p),o.C=0,h=o.j.L,o.h=new Ha,o.g=wc(o.j,h?c:null,!o.u),o.P>0&&(o.O=new zd(d(o.Y,o,o.g),o.P)),c=o.V,h=o.g,p=o.ba;var A="readystatechange";Array.isArray(A)||(A&&(Da[0]=A.toString()),A=Da);for(let R=0;R<A.length;R++){const O=ba(h,A[R],p||c.handleEvent,!1,c.h||c);if(!O)break;c.g[O.key]=O}c=o.J?Ra(o.J):{},o.u?(o.v||(o.v="POST"),c["Content-Type"]="application/x-www-form-urlencoded",o.g.ea(o.B,o.v,o.u,c)):(o.v="GET",o.g.ea(o.B,o.v,null,c)),rr(),Kd(o.i,o.v,o.B,o.l,o.S,o.u)}Et.prototype.ba=function(o){o=o.target;const c=this.O;c&&wt(o)==3?c.j():this.Y(o)},Et.prototype.Y=function(o){try{if(o==this.g)e:{const z=wt(this.g),Te=this.g.ya(),ie=this.g.ca();if(!(z<3)&&(z!=3||this.g&&(this.h.h||this.g.la()||hc(this.g)))){this.K||z!=4||Te==7||(Te==8||ie<=0?rr(3):rr(2)),Ni(this);var c=this.g.ca();this.X=c;var h=Zd(this);if(this.o=c==200,Qd(this.i,this.v,this.B,this.l,this.S,z,c),this.o){if(this.U&&!this.L){t:{if(this.g){var p,A=this.g;if((p=A.g?A.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!_(p)){var R=p;break t}}R=null}if(o=R)gn(this.i,this.l,o,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,ki(this,o);else{this.o=!1,this.m=3,xe(12),Qt(this),ar(this);break e}}if(this.R){o=!0;let Ae;for(;!this.K&&this.C<h.length;)if(Ae=ef(this,h),Ae==Ci){z==4&&(this.m=4,xe(14),o=!1),gn(this.i,this.l,null,"[Incomplete Response]");break}else if(Ae==ja){this.m=4,xe(15),gn(this.i,this.l,h,"[Invalid Chunk]"),o=!1;break}else gn(this.i,this.l,Ae,null),ki(this,Ae);if(Ga(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),z!=4||h.length!=0||this.h.h||(this.m=1,xe(16),o=!1),this.o=this.o&&o,!o)gn(this.i,this.l,h,"[Invalid Chunked Response]"),Qt(this),ar(this);else if(h.length>0&&!this.W){this.W=!0;var O=this.j;O.g==this&&O.aa&&!O.P&&(O.j.info("Great, no buffering proxy detected. Bytes received: "+h.length),Bi(O),O.P=!0,xe(11))}}else gn(this.i,this.l,h,null),ki(this,h);z==4&&Qt(this),this.o&&!this.K&&(z==4?yc(this.j,this):(this.o=!1,as(this)))}else mf(this.g),c==400&&h.indexOf("Unknown SID")>0?(this.m=3,xe(12)):(this.m=0,xe(13)),Qt(this),ar(this)}}}catch{}finally{}};function Zd(o){if(!Ga(o))return o.g.la();const c=hc(o.g);if(c==="")return"";let h="";const p=c.length,A=wt(o.g)==4;if(!o.h.i){if(typeof TextDecoder>"u")return Qt(o),ar(o),"";o.h.i=new a.TextDecoder}for(let R=0;R<p;R++)o.h.h=!0,h+=o.h.i.decode(c[R],{stream:!(A&&R==p-1)});return c.length=0,o.h.g+=h,o.C=0,o.h.g}function Ga(o){return o.g?o.v=="GET"&&o.M!=2&&o.j.Aa:!1}function ef(o,c){var h=o.C,p=c.indexOf(`
`,h);return p==-1?Ci:(h=Number(c.substring(h,p)),isNaN(h)?ja:(p+=1,p+h>c.length?Ci:(c=c.slice(p,p+h),o.C=p+h,c)))}Et.prototype.cancel=function(){this.K=!0,Qt(this)};function as(o){o.T=Date.now()+o.H,Wa(o,o.H)}function Wa(o,c){if(o.D!=null)throw Error("WatchDog timer not null");o.D=sr(d(o.aa,o),c)}function Ni(o){o.D&&(a.clearTimeout(o.D),o.D=null)}Et.prototype.aa=function(){this.D=null;const o=Date.now();o-this.T>=0?(Yd(this.i,this.B),this.M!=2&&(rr(),xe(17)),Qt(this),this.m=2,ar(this)):Wa(this,this.T-o)};function ar(o){o.j.I==0||o.K||yc(o.j,o)}function Qt(o){Ni(o);var c=o.O;c&&typeof c.dispose=="function"&&c.dispose(),o.O=null,Va(o.V),o.g&&(c=o.g,o.g=null,c.abort(),c.dispose())}function ki(o,c){try{var h=o.j;if(h.I!=0&&(h.g==o||Di(h.h,o))){if(!o.L&&Di(h.h,o)&&h.I==3){try{var p=h.Ba.g.parse(c)}catch{p=null}if(Array.isArray(p)&&p.length==3){var A=p;if(A[0]==0){e:if(!h.v){if(h.g)if(h.g.F+3e3<o.F)fs(h),hs(h);else break e;Ui(h),xe(18)}}else h.xa=A[1],0<h.xa-h.K&&A[2]<37500&&h.F&&h.A==0&&!h.C&&(h.C=sr(d(h.Va,h),6e3));Ya(h.h)<=1&&h.ta&&(h.ta=void 0)}else Xt(h,11)}else if((o.L||h.g==o)&&fs(h),!_(c))for(A=h.Ba.g.parse(c),c=0;c<A.length;c++){let ie=A[c];const Ae=ie[0];if(!(Ae<=h.K))if(h.K=Ae,ie=ie[1],h.I==2)if(ie[0]=="c"){h.M=ie[1],h.ba=ie[2];const Ze=ie[3];Ze!=null&&(h.ka=Ze,h.j.info("VER="+h.ka));const Jt=ie[4];Jt!=null&&(h.za=Jt,h.j.info("SVER="+h.za));const At=ie[5];At!=null&&typeof At=="number"&&At>0&&(p=1.5*At,h.O=p,h.j.info("backChannelRequestTimeoutMs_="+p)),p=h;const vt=o.g;if(vt){const ms=vt.g?vt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(ms){var R=p.h;R.g||ms.indexOf("spdy")==-1&&ms.indexOf("quic")==-1&&ms.indexOf("h2")==-1||(R.j=R.l,R.g=new Set,R.h&&(Vi(R,R.h),R.h=null))}if(p.G){const qi=vt.g?vt.g.getResponseHeader("X-HTTP-Session-Id"):null;qi&&(p.wa=qi,ce(p.J,p.G,qi))}}h.I=3,h.l&&h.l.ra(),h.aa&&(h.T=Date.now()-o.F,h.j.info("Handshake RTT: "+h.T+"ms")),p=h;var O=o;if(p.na=Tc(p,p.L?p.ba:null,p.W),O.L){Xa(p.h,O);var z=O,Te=p.O;Te&&(z.H=Te),z.D&&(Ni(z),as(z)),p.g=O}else gc(p);h.i.length>0&&ds(h)}else ie[0]!="stop"&&ie[0]!="close"||Xt(h,7);else h.I==3&&(ie[0]=="stop"||ie[0]=="close"?ie[0]=="stop"?Xt(h,7):Fi(h):ie[0]!="noop"&&h.l&&h.l.qa(ie),h.A=0)}}rr(4)}catch{}}var tf=class{constructor(o,c){this.g=o,this.map=c}};function Ka(o){this.l=o||10,a.PerformanceNavigationTiming?(o=a.performance.getEntriesByType("navigation"),o=o.length>0&&(o[0].nextHopProtocol=="hq"||o[0].nextHopProtocol=="h2")):o=!!(a.chrome&&a.chrome.loadTimes&&a.chrome.loadTimes()&&a.chrome.loadTimes().wasFetchedViaSpdy),this.j=o?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function Qa(o){return o.h?!0:o.g?o.g.size>=o.j:!1}function Ya(o){return o.h?1:o.g?o.g.size:0}function Di(o,c){return o.h?o.h==c:o.g?o.g.has(c):!1}function Vi(o,c){o.g?o.g.add(c):o.h=c}function Xa(o,c){o.h&&o.h==c?o.h=null:o.g&&o.g.has(c)&&o.g.delete(c)}Ka.prototype.cancel=function(){if(this.i=Ja(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const o of this.g.values())o.cancel();this.g.clear()}};function Ja(o){if(o.h!=null)return o.i.concat(o.h.G);if(o.g!=null&&o.g.size!==0){let c=o.i;for(const h of o.g.values())c=c.concat(h.G);return c}return S(o.i)}var Za=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function nf(o,c){if(o){o=o.split("&");for(let h=0;h<o.length;h++){const p=o[h].indexOf("=");let A,R=null;p>=0?(A=o[h].substring(0,p),R=o[h].substring(p+1)):A=o[h],c(A,R?decodeURIComponent(R.replace(/\+/g," ")):"")}}}function It(o){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let c;o instanceof It?(this.l=o.l,cr(this,o.j),this.o=o.o,this.g=o.g,ur(this,o.u),this.h=o.h,Li(this,ic(o.i)),this.m=o.m):o&&(c=String(o).match(Za))?(this.l=!1,cr(this,c[1]||"",!0),this.o=lr(c[2]||""),this.g=lr(c[3]||"",!0),ur(this,c[4]),this.h=lr(c[5]||"",!0),Li(this,c[6]||"",!0),this.m=lr(c[7]||"")):(this.l=!1,this.i=new dr(null,this.l))}It.prototype.toString=function(){const o=[];var c=this.j;c&&o.push(hr(c,ec,!0),":");var h=this.g;return(h||c=="file")&&(o.push("//"),(c=this.o)&&o.push(hr(c,ec,!0),"@"),o.push(or(h).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),h=this.u,h!=null&&o.push(":",String(h))),(h=this.h)&&(this.g&&h.charAt(0)!="/"&&o.push("/"),o.push(hr(h,h.charAt(0)=="/"?of:sf,!0))),(h=this.i.toString())&&o.push("?",h),(h=this.m)&&o.push("#",hr(h,cf)),o.join("")},It.prototype.resolve=function(o){const c=Je(this);let h=!!o.j;h?cr(c,o.j):h=!!o.o,h?c.o=o.o:h=!!o.g,h?c.g=o.g:h=o.u!=null;var p=o.h;if(h)ur(c,o.u);else if(h=!!o.h){if(p.charAt(0)!="/")if(this.g&&!this.h)p="/"+p;else{var A=c.h.lastIndexOf("/");A!=-1&&(p=c.h.slice(0,A+1)+p)}if(A=p,A==".."||A==".")p="";else if(A.indexOf("./")!=-1||A.indexOf("/.")!=-1){p=A.lastIndexOf("/",0)==0,A=A.split("/");const R=[];for(let O=0;O<A.length;){const z=A[O++];z=="."?p&&O==A.length&&R.push(""):z==".."?((R.length>1||R.length==1&&R[0]!="")&&R.pop(),p&&O==A.length&&R.push("")):(R.push(z),p=!0)}p=R.join("/")}else p=A}return h?c.h=p:h=o.i.toString()!=="",h?Li(c,ic(o.i)):h=!!o.m,h&&(c.m=o.m),c};function Je(o){return new It(o)}function cr(o,c,h){o.j=h?lr(c,!0):c,o.j&&(o.j=o.j.replace(/:$/,""))}function ur(o,c){if(c){if(c=Number(c),isNaN(c)||c<0)throw Error("Bad port number "+c);o.u=c}else o.u=null}function Li(o,c,h){c instanceof dr?(o.i=c,uf(o.i,o.l)):(h||(c=hr(c,af)),o.i=new dr(c,o.l))}function ce(o,c,h){o.i.set(c,h)}function cs(o){return ce(o,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),o}function lr(o,c){return o?c?decodeURI(o.replace(/%25/g,"%2525")):decodeURIComponent(o):""}function hr(o,c,h){return typeof o=="string"?(o=encodeURI(o).replace(c,rf),h&&(o=o.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),o):null}function rf(o){return o=o.charCodeAt(0),"%"+(o>>4&15).toString(16)+(o&15).toString(16)}var ec=/[#\/\?@]/g,sf=/[#\?:]/g,of=/[#\?]/g,af=/[#\?@]/g,cf=/#/g;function dr(o,c){this.h=this.g=null,this.i=o||null,this.j=!!c}function Yt(o){o.g||(o.g=new Map,o.h=0,o.i&&nf(o.i,function(c,h){o.add(decodeURIComponent(c.replace(/\+/g," ")),h)}))}n=dr.prototype,n.add=function(o,c){Yt(this),this.i=null,o=_n(this,o);let h=this.g.get(o);return h||this.g.set(o,h=[]),h.push(c),this.h+=1,this};function tc(o,c){Yt(o),c=_n(o,c),o.g.has(c)&&(o.i=null,o.h-=o.g.get(c).length,o.g.delete(c))}function nc(o,c){return Yt(o),c=_n(o,c),o.g.has(c)}n.forEach=function(o,c){Yt(this),this.g.forEach(function(h,p){h.forEach(function(A){o.call(c,A,p,this)},this)},this)};function rc(o,c){Yt(o);let h=[];if(typeof c=="string")nc(o,c)&&(h=h.concat(o.g.get(_n(o,c))));else for(o=Array.from(o.g.values()),c=0;c<o.length;c++)h=h.concat(o[c]);return h}n.set=function(o,c){return Yt(this),this.i=null,o=_n(this,o),nc(this,o)&&(this.h-=this.g.get(o).length),this.g.set(o,[c]),this.h+=1,this},n.get=function(o,c){return o?(o=rc(this,o),o.length>0?String(o[0]):c):c};function sc(o,c,h){tc(o,c),h.length>0&&(o.i=null,o.g.set(_n(o,c),S(h)),o.h+=h.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const o=[],c=Array.from(this.g.keys());for(let p=0;p<c.length;p++){var h=c[p];const A=or(h);h=rc(this,h);for(let R=0;R<h.length;R++){let O=A;h[R]!==""&&(O+="="+or(h[R])),o.push(O)}}return this.i=o.join("&")};function ic(o){const c=new dr;return c.i=o.i,o.g&&(c.g=new Map(o.g),c.h=o.h),c}function _n(o,c){return c=String(c),o.j&&(c=c.toLowerCase()),c}function uf(o,c){c&&!o.j&&(Yt(o),o.i=null,o.g.forEach(function(h,p){const A=p.toLowerCase();p!=A&&(tc(this,p),sc(this,A,h))},o)),o.j=c}function lf(o,c){const h=new ir;if(a.Image){const p=new Image;p.onload=f(Tt,h,"TestLoadImage: loaded",!0,c,p),p.onerror=f(Tt,h,"TestLoadImage: error",!1,c,p),p.onabort=f(Tt,h,"TestLoadImage: abort",!1,c,p),p.ontimeout=f(Tt,h,"TestLoadImage: timeout",!1,c,p),a.setTimeout(function(){p.ontimeout&&p.ontimeout()},1e4),p.src=o}else c(!1)}function hf(o,c){const h=new ir,p=new AbortController,A=setTimeout(()=>{p.abort(),Tt(h,"TestPingServer: timeout",!1,c)},1e4);fetch(o,{signal:p.signal}).then(R=>{clearTimeout(A),R.ok?Tt(h,"TestPingServer: ok",!0,c):Tt(h,"TestPingServer: server error",!1,c)}).catch(()=>{clearTimeout(A),Tt(h,"TestPingServer: error",!1,c)})}function Tt(o,c,h,p,A){try{A&&(A.onload=null,A.onerror=null,A.onabort=null,A.ontimeout=null),p(h)}catch{}}function df(){this.g=new Wd}function Mi(o){this.i=o.Sb||null,this.h=o.ab||!1}m(Mi,La),Mi.prototype.g=function(){return new us(this.i,this.h)};function us(o,c){Ce.call(this),this.H=o,this.o=c,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}m(us,Ce),n=us.prototype,n.open=function(o,c){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=o,this.D=c,this.readyState=1,pr(this)},n.send=function(o){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const c={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};o&&(c.body=o),(this.H||a).fetch(new Request(this.D,c)).then(this.Pa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,fr(this)),this.readyState=0},n.Pa=function(o){if(this.g&&(this.l=o,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=o.headers,this.readyState=2,pr(this)),this.g&&(this.readyState=3,pr(this),this.g)))if(this.responseType==="arraybuffer")o.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof a.ReadableStream<"u"&&"body"in o){if(this.j=o.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;oc(this)}else o.text().then(this.Oa.bind(this),this.ga.bind(this))};function oc(o){o.j.read().then(o.Ma.bind(o)).catch(o.ga.bind(o))}n.Ma=function(o){if(this.g){if(this.o&&o.value)this.response.push(o.value);else if(!this.o){var c=o.value?o.value:new Uint8Array(0);(c=this.B.decode(c,{stream:!o.done}))&&(this.response=this.responseText+=c)}o.done?fr(this):pr(this),this.readyState==3&&oc(this)}},n.Oa=function(o){this.g&&(this.response=this.responseText=o,fr(this))},n.Na=function(o){this.g&&(this.response=o,fr(this))},n.ga=function(){this.g&&fr(this)};function fr(o){o.readyState=4,o.l=null,o.j=null,o.B=null,pr(o)}n.setRequestHeader=function(o,c){this.A.append(o,c)},n.getResponseHeader=function(o){return this.h&&this.h.get(o.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const o=[],c=this.h.entries();for(var h=c.next();!h.done;)h=h.value,o.push(h[0]+": "+h[1]),h=c.next();return o.join(`\r
`)};function pr(o){o.onreadystatechange&&o.onreadystatechange.call(o)}Object.defineProperty(us.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(o){this.m=o?"include":"same-origin"}});function ac(o){let c="";return ns(o,function(h,p){c+=p,c+=":",c+=h,c+=`\r
`}),c}function xi(o,c,h){e:{for(p in h){var p=!1;break e}p=!0}p||(h=ac(h),typeof o=="string"?h!=null&&or(h):ce(o,c,h))}function pe(o){Ce.call(this),this.headers=new Map,this.L=o||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}m(pe,Ce);var ff=/^https?$/i,pf=["POST","PUT"];n=pe.prototype,n.Fa=function(o){this.H=o},n.ea=function(o,c,h,p){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+o);c=c?c.toUpperCase():"GET",this.D=o,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():$a.g(),this.g.onreadystatechange=I(d(this.Ca,this));try{this.B=!0,this.g.open(c,String(o),!0),this.B=!1}catch(R){cc(this,R);return}if(o=h||"",h=new Map(this.headers),p)if(Object.getPrototypeOf(p)===Object.prototype)for(var A in p)h.set(A,p[A]);else if(typeof p.keys=="function"&&typeof p.get=="function")for(const R of p.keys())h.set(R,p.get(R));else throw Error("Unknown input type for opt_headers: "+String(p));p=Array.from(h.keys()).find(R=>R.toLowerCase()=="content-type"),A=a.FormData&&o instanceof a.FormData,!(Array.prototype.indexOf.call(pf,c,void 0)>=0)||p||A||h.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[R,O]of h)this.g.setRequestHeader(R,O);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(o),this.v=!1}catch(R){cc(this,R)}};function cc(o,c){o.h=!1,o.g&&(o.j=!0,o.g.abort(),o.j=!1),o.l=c,o.o=5,uc(o),ls(o)}function uc(o){o.A||(o.A=!0,Me(o,"complete"),Me(o,"error"))}n.abort=function(o){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=o||7,Me(this,"complete"),Me(this,"abort"),ls(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),ls(this,!0)),pe.Z.N.call(this)},n.Ca=function(){this.u||(this.B||this.v||this.j?lc(this):this.Xa())},n.Xa=function(){lc(this)};function lc(o){if(o.h&&typeof i<"u"){if(o.v&&wt(o)==4)setTimeout(o.Ca.bind(o),0);else if(Me(o,"readystatechange"),wt(o)==4){o.h=!1;try{const R=o.ca();e:switch(R){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var c=!0;break e;default:c=!1}var h;if(!(h=c)){var p;if(p=R===0){let O=String(o.D).match(Za)[1]||null;!O&&a.self&&a.self.location&&(O=a.self.location.protocol.slice(0,-1)),p=!ff.test(O?O.toLowerCase():"")}h=p}if(h)Me(o,"complete"),Me(o,"success");else{o.o=6;try{var A=wt(o)>2?o.g.statusText:""}catch{A=""}o.l=A+" ["+o.ca()+"]",uc(o)}}finally{ls(o)}}}}function ls(o,c){if(o.g){o.m&&(clearTimeout(o.m),o.m=null);const h=o.g;o.g=null,c||Me(o,"ready");try{h.onreadystatechange=null}catch{}}}n.isActive=function(){return!!this.g};function wt(o){return o.g?o.g.readyState:0}n.ca=function(){try{return wt(this)>2?this.g.status:-1}catch{return-1}},n.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.La=function(o){if(this.g){var c=this.g.responseText;return o&&c.indexOf(o)==0&&(c=c.substring(o.length)),Gd(c)}};function hc(o){try{if(!o.g)return null;if("response"in o.g)return o.g.response;switch(o.F){case"":case"text":return o.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in o.g)return o.g.mozResponseArrayBuffer}return null}catch{return null}}function mf(o){const c={};o=(o.g&&wt(o)>=2&&o.g.getAllResponseHeaders()||"").split(`\r
`);for(let p=0;p<o.length;p++){if(_(o[p]))continue;var h=Jd(o[p]);const A=h[0];if(h=h[1],typeof h!="string")continue;h=h.trim();const R=c[A]||[];c[A]=R,R.push(h)}Bd(c,function(p){return p.join(", ")})}n.ya=function(){return this.o},n.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function mr(o,c,h){return h&&h.internalChannelParams&&h.internalChannelParams[o]||c}function dc(o){this.za=0,this.i=[],this.j=new ir,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=mr("failFast",!1,o),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=mr("baseRetryDelayMs",5e3,o),this.Za=mr("retryDelaySeedMs",1e4,o),this.Ta=mr("forwardChannelMaxRetries",2,o),this.va=mr("forwardChannelRequestTimeoutMs",2e4,o),this.ma=o&&o.xmlHttpFactory||void 0,this.Ua=o&&o.Rb||void 0,this.Aa=o&&o.useFetchStreams||!1,this.O=void 0,this.L=o&&o.supportsCrossDomainXhr||!1,this.M="",this.h=new Ka(o&&o.concurrentRequestLimit),this.Ba=new df,this.S=o&&o.fastHandshake||!1,this.R=o&&o.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=o&&o.Pb||!1,o&&o.ua&&this.j.ua(),o&&o.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&o&&o.detectBufferingProxy||!1,this.ia=void 0,o&&o.longPollingTimeout&&o.longPollingTimeout>0&&(this.ia=o.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}n=dc.prototype,n.ka=8,n.I=1,n.connect=function(o,c,h,p){xe(0),this.W=o,this.H=c||{},h&&p!==void 0&&(this.H.OSID=h,this.H.OAID=p),this.F=this.X,this.J=Tc(this,null,this.W),ds(this)};function Fi(o){if(fc(o),o.I==3){var c=o.V++,h=Je(o.J);if(ce(h,"SID",o.M),ce(h,"RID",c),ce(h,"TYPE","terminate"),gr(o,h),c=new Et(o,o.j,c),c.M=2,c.A=cs(Je(h)),h=!1,a.navigator&&a.navigator.sendBeacon)try{h=a.navigator.sendBeacon(c.A.toString(),"")}catch{}!h&&a.Image&&(new Image().src=c.A,h=!0),h||(c.g=wc(c.j,null),c.g.ea(c.A)),c.F=Date.now(),as(c)}Ic(o)}function hs(o){o.g&&(Bi(o),o.g.cancel(),o.g=null)}function fc(o){hs(o),o.v&&(a.clearTimeout(o.v),o.v=null),fs(o),o.h.cancel(),o.m&&(typeof o.m=="number"&&a.clearTimeout(o.m),o.m=null)}function ds(o){if(!Qa(o.h)&&!o.m){o.m=!0;var c=o.Ea;K||g(),Q||(K(),Q=!0),E.add(c,o),o.D=0}}function gf(o,c){return Ya(o.h)>=o.h.j-(o.m?1:0)?!1:o.m?(o.i=c.G.concat(o.i),!0):o.I==1||o.I==2||o.D>=(o.Sa?0:o.Ta)?!1:(o.m=sr(d(o.Ea,o,c),Ec(o,o.D)),o.D++,!0)}n.Ea=function(o){if(this.m)if(this.m=null,this.I==1){if(!o){this.V=Math.floor(Math.random()*1e5),o=this.V++;const A=new Et(this,this.j,o);let R=this.o;if(this.U&&(R?(R=Ra(R),Pa(R,this.U)):R=this.U),this.u!==null||this.R||(A.J=R,R=null),this.S)e:{for(var c=0,h=0;h<this.i.length;h++){t:{var p=this.i[h];if("__data__"in p.map&&(p=p.map.__data__,typeof p=="string")){p=p.length;break t}p=void 0}if(p===void 0)break;if(c+=p,c>4096){c=h;break e}if(c===4096||h===this.i.length-1){c=h+1;break e}}c=1e3}else c=1e3;c=mc(this,A,c),h=Je(this.J),ce(h,"RID",o),ce(h,"CVER",22),this.G&&ce(h,"X-HTTP-Session-Id",this.G),gr(this,h),R&&(this.R?c="headers="+or(ac(R))+"&"+c:this.u&&xi(h,this.u,R)),Vi(this.h,A),this.Ra&&ce(h,"TYPE","init"),this.S?(ce(h,"$req",c),ce(h,"SID","null"),A.U=!0,Oi(A,h,null)):Oi(A,h,c),this.I=2}}else this.I==3&&(o?pc(this,o):this.i.length==0||Qa(this.h)||pc(this))};function pc(o,c){var h;c?h=c.l:h=o.V++;const p=Je(o.J);ce(p,"SID",o.M),ce(p,"RID",h),ce(p,"AID",o.K),gr(o,p),o.u&&o.o&&xi(p,o.u,o.o),h=new Et(o,o.j,h,o.D+1),o.u===null&&(h.J=o.o),c&&(o.i=c.G.concat(o.i)),c=mc(o,h,1e3),h.H=Math.round(o.va*.5)+Math.round(o.va*.5*Math.random()),Vi(o.h,h),Oi(h,p,c)}function gr(o,c){o.H&&ns(o.H,function(h,p){ce(c,p,h)}),o.l&&ns({},function(h,p){ce(c,p,h)})}function mc(o,c,h){h=Math.min(o.i.length,h);const p=o.l?d(o.l.Ka,o.l,o):null;e:{var A=o.i;let z=-1;for(;;){const Te=["count="+h];z==-1?h>0?(z=A[0].g,Te.push("ofs="+z)):z=0:Te.push("ofs="+z);let ie=!0;for(let Ae=0;Ae<h;Ae++){var R=A[Ae].g;const Ze=A[Ae].map;if(R-=z,R<0)z=Math.max(0,A[Ae].g-100),ie=!1;else try{R="req"+R+"_"||"";try{var O=Ze instanceof Map?Ze:Object.entries(Ze);for(const[Jt,At]of O){let vt=At;u(At)&&(vt=Ri(At)),Te.push(R+Jt+"="+encodeURIComponent(vt))}}catch(Jt){throw Te.push(R+"type="+encodeURIComponent("_badmap")),Jt}}catch{p&&p(Ze)}}if(ie){O=Te.join("&");break e}}O=void 0}return o=o.i.splice(0,h),c.G=o,O}function gc(o){if(!o.g&&!o.v){o.Y=1;var c=o.Da;K||g(),Q||(K(),Q=!0),E.add(c,o),o.A=0}}function Ui(o){return o.g||o.v||o.A>=3?!1:(o.Y++,o.v=sr(d(o.Da,o),Ec(o,o.A)),o.A++,!0)}n.Da=function(){if(this.v=null,_c(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var o=4*this.T;this.j.info("BP detection timer enabled: "+o),this.B=sr(d(this.Wa,this),o)}},n.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,xe(10),hs(this),_c(this))};function Bi(o){o.B!=null&&(a.clearTimeout(o.B),o.B=null)}function _c(o){o.g=new Et(o,o.j,"rpc",o.Y),o.u===null&&(o.g.J=o.o),o.g.P=0;var c=Je(o.na);ce(c,"RID","rpc"),ce(c,"SID",o.M),ce(c,"AID",o.K),ce(c,"CI",o.F?"0":"1"),!o.F&&o.ia&&ce(c,"TO",o.ia),ce(c,"TYPE","xmlhttp"),gr(o,c),o.u&&o.o&&xi(c,o.u,o.o),o.O&&(o.g.H=o.O);var h=o.g;o=o.ba,h.M=1,h.A=cs(Je(c)),h.u=null,h.R=!0,za(h,o)}n.Va=function(){this.C!=null&&(this.C=null,hs(this),Ui(this),xe(19))};function fs(o){o.C!=null&&(a.clearTimeout(o.C),o.C=null)}function yc(o,c){var h=null;if(o.g==c){fs(o),Bi(o),o.g=null;var p=2}else if(Di(o.h,c))h=c.G,Xa(o.h,c),p=1;else return;if(o.I!=0){if(c.o)if(p==1){h=c.u?c.u.length:0,c=Date.now()-c.F;var A=o.D;p=is(),Me(p,new Ba(p,h)),ds(o)}else gc(o);else if(A=c.m,A==3||A==0&&c.X>0||!(p==1&&gf(o,c)||p==2&&Ui(o)))switch(h&&h.length>0&&(c=o.h,c.i=c.i.concat(h)),A){case 1:Xt(o,5);break;case 4:Xt(o,10);break;case 3:Xt(o,6);break;default:Xt(o,2)}}}function Ec(o,c){let h=o.Qa+Math.floor(Math.random()*o.Za);return o.isActive()||(h*=2),h*c}function Xt(o,c){if(o.j.info("Error code "+c),c==2){var h=d(o.bb,o),p=o.Ua;const A=!p;p=new It(p||"//www.google.com/images/cleardot.gif"),a.location&&a.location.protocol=="http"||cr(p,"https"),cs(p),A?lf(p.toString(),h):hf(p.toString(),h)}else xe(2);o.I=0,o.l&&o.l.pa(c),Ic(o),fc(o)}n.bb=function(o){o?(this.j.info("Successfully pinged google.com"),xe(2)):(this.j.info("Failed to ping google.com"),xe(1))};function Ic(o){if(o.I=0,o.ja=[],o.l){const c=Ja(o.h);(c.length!=0||o.i.length!=0)&&(C(o.ja,c),C(o.ja,o.i),o.h.i.length=0,S(o.i),o.i.length=0),o.l.oa()}}function Tc(o,c,h){var p=h instanceof It?Je(h):new It(h);if(p.g!="")c&&(p.g=c+"."+p.g),ur(p,p.u);else{var A=a.location;p=A.protocol,c=c?c+"."+A.hostname:A.hostname,A=+A.port;const R=new It(null);p&&cr(R,p),c&&(R.g=c),A&&ur(R,A),h&&(R.h=h),p=R}return h=o.G,c=o.wa,h&&c&&ce(p,h,c),ce(p,"VER",o.ka),gr(o,p),p}function wc(o,c,h){if(c&&!o.L)throw Error("Can't create secondary domain capable XhrIo object.");return c=o.Aa&&!o.ma?new pe(new Mi({ab:h})):new pe(o.ma),c.Fa(o.L),c}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function Ac(){}n=Ac.prototype,n.ra=function(){},n.qa=function(){},n.pa=function(){},n.oa=function(){},n.isActive=function(){return!0},n.Ka=function(){};function ps(){}ps.prototype.g=function(o,c){return new qe(o,c)};function qe(o,c){Ce.call(this),this.g=new dc(c),this.l=o,this.h=c&&c.messageUrlParams||null,o=c&&c.messageHeaders||null,c&&c.clientProtocolHeaderRequired&&(o?o["X-Client-Protocol"]="webchannel":o={"X-Client-Protocol":"webchannel"}),this.g.o=o,o=c&&c.initMessageHeaders||null,c&&c.messageContentType&&(o?o["X-WebChannel-Content-Type"]=c.messageContentType:o={"X-WebChannel-Content-Type":c.messageContentType}),c&&c.sa&&(o?o["X-WebChannel-Client-Profile"]=c.sa:o={"X-WebChannel-Client-Profile":c.sa}),this.g.U=o,(o=c&&c.Qb)&&!_(o)&&(this.g.u=o),this.A=c&&c.supportsCrossDomainXhr||!1,this.v=c&&c.sendRawJson||!1,(c=c&&c.httpSessionIdParam)&&!_(c)&&(this.g.G=c,o=this.h,o!==null&&c in o&&(o=this.h,c in o&&delete o[c])),this.j=new yn(this)}m(qe,Ce),qe.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},qe.prototype.close=function(){Fi(this.g)},qe.prototype.o=function(o){var c=this.g;if(typeof o=="string"){var h={};h.__data__=o,o=h}else this.v&&(h={},h.__data__=Ri(o),o=h);c.i.push(new tf(c.Ya++,o)),c.I==3&&ds(c)},qe.prototype.N=function(){this.g.l=null,delete this.j,Fi(this.g),delete this.g,qe.Z.N.call(this)};function vc(o){Si.call(this),o.__headers__&&(this.headers=o.__headers__,this.statusCode=o.__status__,delete o.__headers__,delete o.__status__);var c=o.__sm__;if(c){e:{for(const h in c){o=h;break e}o=void 0}(this.i=o)&&(o=this.i,c=c!==null&&o in c?c[o]:void 0),this.data=c}else this.data=o}m(vc,Si);function Rc(){Pi.call(this),this.status=1}m(Rc,Pi);function yn(o){this.g=o}m(yn,Ac),yn.prototype.ra=function(){Me(this.g,"a")},yn.prototype.qa=function(o){Me(this.g,new vc(o))},yn.prototype.pa=function(o){Me(this.g,new Rc)},yn.prototype.oa=function(){Me(this.g,"b")},ps.prototype.createWebChannel=ps.prototype.g,qe.prototype.send=qe.prototype.o,qe.prototype.open=qe.prototype.m,qe.prototype.close=qe.prototype.close,Sl=function(){return new ps},Rl=function(){return is()},vl=Kt,co={jb:0,mb:1,nb:2,Hb:3,Mb:4,Jb:5,Kb:6,Ib:7,Gb:8,Lb:9,PROXY:10,NOPROXY:11,Eb:12,Ab:13,Bb:14,zb:15,Cb:16,Db:17,fb:18,eb:19,gb:20},os.NO_ERROR=0,os.TIMEOUT=8,os.HTTP_ERROR=6,ws=os,qa.COMPLETE="complete",Al=qa,Ma.EventType=nr,nr.OPEN="a",nr.CLOSE="b",nr.ERROR="c",nr.MESSAGE="d",Ce.prototype.listen=Ce.prototype.J,Ir=Ma,pe.prototype.listenOnce=pe.prototype.K,pe.prototype.getLastError=pe.prototype.Ha,pe.prototype.getLastErrorCode=pe.prototype.ya,pe.prototype.getStatus=pe.prototype.ca,pe.prototype.getResponseJson=pe.prototype.La,pe.prototype.getResponseText=pe.prototype.la,pe.prototype.send=pe.prototype.ea,pe.prototype.setWithCredentials=pe.prototype.Fa,wl=pe}).apply(typeof gs<"u"?gs:typeof self<"u"?self:typeof window<"u"?window:{});const Fc="@firebase/firestore",Uc="4.9.3";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const on=new Co("@firebase/firestore");function In(){return on.logLevel}function V(n,...e){if(on.logLevel<=J.DEBUG){const t=e.map(ko);on.debug(`Firestore (${Gn}): ${n}`,...t)}}function pt(n,...e){if(on.logLevel<=J.ERROR){const t=e.map(ko);on.error(`Firestore (${Gn}): ${n}`,...t)}}function Ln(n,...e){if(on.logLevel<=J.WARN){const t=e.map(ko);on.warn(`Firestore (${Gn}): ${n}`,...t)}}function ko(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function q(n,e,t){let r="Unexpected state";typeof e=="string"?r=e:t=e,Pl(n,r,t)}function Pl(n,e,t){let r=`FIRESTORE (${Gn}) INTERNAL ASSERTION FAILED: ${e} (ID: ${n.toString(16)})`;if(t!==void 0)try{r+=" CONTEXT: "+JSON.stringify(t)}catch{r+=" CONTEXT: "+t}throw pt(r),new Error(r)}function se(n,e,t,r){let s="Unexpected state";typeof t=="string"?s=t:r=t,n||Pl(e,s,r)}function H(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Do{static newId(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",t=62*Math.floor(4.129032258064516);let r="";for(;r.length<20;){const s=pm(40);for(let i=0;i<s.length;++i)r.length<20&&s[i]<t&&(r+=e.charAt(s[i]%62))}return r}}function Z(n,e){return n<e?-1:n>e?1:0}function uo(n,e){const t=Math.min(n.length,e.length);for(let r=0;r<t;r++){const s=n.charAt(r),i=e.charAt(r);if(s!==i)return Ki(s)===Ki(i)?Z(s,i):Ki(s)?1:-1}return Z(n.length,e.length)}const mm=55296,gm=57343;function Ki(n){const e=n.charCodeAt(0);return e>=mm&&e<=gm}function Mn(n,e,t){return n.length===e.length&&n.every((r,s)=>t(r,e[s]))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vl="server_timestamp",Ll="__type__",Ml="__previous_value__",xl="__local_write_time__";function Lo(n){var t,r;return((r=(((t=n==null?void 0:n.mapValue)==null?void 0:t.fields)||{})[Ll])==null?void 0:r.stringValue)===Vl}function ri(n){const e=n.mapValue.fields[Ml];return Lo(e)?ri(e):e}function Mr(n){const e=Bt(n.mapValue.fields[xl].timestampValue);return new ue(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Om{constructor(e,t,r,s,i,a,u,l,d,f){this.databaseId=e,this.appId=t,this.persistenceKey=r,this.host=s,this.ssl=i,this.forceLongPolling=a,this.autoDetectLongPolling=u,this.longPollingOptions=l,this.useFetchStreams=d,this.isUsingEmulator=f}}const Ms="(default)";class xr{constructor(e,t){this.projectId=e,this.database=t||Ms}static empty(){return new xr("","")}get isDefaultDatabase(){return this.database===Ms}isEqual(e){return e instanceof xr&&e.projectId===this.projectId&&e.database===this.database}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fl="__type__",Nm="__max__",ys={mapValue:{}},Ul="__vector__",xs="value";function $t(n){return"nullValue"in n?0:"booleanValue"in n?1:"integerValue"in n||"doubleValue"in n?2:"timestampValue"in n?3:"stringValue"in n?5:"bytesValue"in n?6:"referenceValue"in n?7:"geoPointValue"in n?8:"arrayValue"in n?9:"mapValue"in n?Lo(n)?4:Dm(n)?9007199254740991:km(n)?10:11:q(28295,{value:n})}function at(n,e){if(n===e)return!0;const t=$t(n);if(t!==$t(e))return!1;switch(t){case 0:case 9007199254740991:return!0;case 1:return n.booleanValue===e.booleanValue;case 4:return Mr(n).isEqual(Mr(e));case 3:return function(s,i){if(typeof s.timestampValue=="string"&&typeof i.timestampValue=="string"&&s.timestampValue.length===i.timestampValue.length)return s.timestampValue===i.timestampValue;const a=Bt(s.timestampValue),u=Bt(i.timestampValue);return a.seconds===u.seconds&&a.nanos===u.nanos}(n,e);case 5:return n.stringValue===e.stringValue;case 6:return function(s,i){return qt(s.bytesValue).isEqual(qt(i.bytesValue))}(n,e);case 7:return n.referenceValue===e.referenceValue;case 8:return function(s,i){return me(s.geoPointValue.latitude)===me(i.geoPointValue.latitude)&&me(s.geoPointValue.longitude)===me(i.geoPointValue.longitude)}(n,e);case 2:return function(s,i){if("integerValue"in s&&"integerValue"in i)return me(s.integerValue)===me(i.integerValue);if("doubleValue"in s&&"doubleValue"in i){const a=me(s.doubleValue),u=me(i.doubleValue);return a===u?Ls(a)===Ls(u):isNaN(a)&&isNaN(u)}return!1}(n,e);case 9:return Mn(n.arrayValue.values||[],e.arrayValue.values||[],at);case 10:case 11:return function(s,i){const a=s.mapValue.fields||{},u=i.mapValue.fields||{};if(Wc(a)!==Wc(u))return!1;for(const l in a)if(a.hasOwnProperty(l)&&(u[l]===void 0||!at(a[l],u[l])))return!1;return!0}(n,e);default:return q(52216,{left:n})}}function Fr(n,e){return(n.values||[]).find(t=>at(t,e))!==void 0}function xn(n,e){if(n===e)return 0;const t=$t(n),r=$t(e);if(t!==r)return Z(t,r);switch(t){case 0:case 9007199254740991:return 0;case 1:return Z(n.booleanValue,e.booleanValue);case 2:return function(i,a){const u=me(i.integerValue||i.doubleValue),l=me(a.integerValue||a.doubleValue);return u<l?-1:u>l?1:u===l?0:isNaN(u)?isNaN(l)?0:-1:1}(n,e);case 3:return Qc(n.timestampValue,e.timestampValue);case 4:return Qc(Mr(n),Mr(e));case 5:return uo(n.stringValue,e.stringValue);case 6:return function(i,a){const u=qt(i),l=qt(a);return u.compareTo(l)}(n.bytesValue,e.bytesValue);case 7:return function(i,a){const u=i.split("/"),l=a.split("/");for(let d=0;d<u.length&&d<l.length;d++){const f=Z(u[d],l[d]);if(f!==0)return f}return Z(u.length,l.length)}(n.referenceValue,e.referenceValue);case 8:return function(i,a){const u=Z(me(i.latitude),me(a.latitude));return u!==0?u:Z(me(i.longitude),me(a.longitude))}(n.geoPointValue,e.geoPointValue);case 9:return Yc(n.arrayValue,e.arrayValue);case 10:return function(i,a){var I,S,C,D;const u=i.fields||{},l=a.fields||{},d=(I=u[xs])==null?void 0:I.arrayValue,f=(S=l[xs])==null?void 0:S.arrayValue,m=Z(((C=d==null?void 0:d.values)==null?void 0:C.length)||0,((D=f==null?void 0:f.values)==null?void 0:D.length)||0);return m!==0?m:Yc(d,f)}(n.mapValue,e.mapValue);case 11:return function(i,a){if(i===ys.mapValue&&a===ys.mapValue)return 0;if(i===ys.mapValue)return 1;if(a===ys.mapValue)return-1;const u=i.fields||{},l=Object.keys(u),d=a.fields||{},f=Object.keys(d);l.sort(),f.sort();for(let m=0;m<l.length&&m<f.length;++m){const I=uo(l[m],f[m]);if(I!==0)return I;const S=xn(u[l[m]],d[f[m]]);if(S!==0)return S}return Z(l.length,f.length)}(n.mapValue,e.mapValue);default:throw q(23264,{he:t})}}function Qc(n,e){if(typeof n=="string"&&typeof e=="string"&&n.length===e.length)return Z(n,e);const t=Bt(n),r=Bt(e),s=Z(t.seconds,r.seconds);return s!==0?s:Z(t.nanos,r.nanos)}function Yc(n,e){const t=n.values||[],r=e.values||[];for(let s=0;s<t.length&&s<r.length;++s){const i=xn(t[s],r[s]);if(i)return i}return Z(t.length,r.length)}function Fn(n){return lo(n)}function lo(n){return"nullValue"in n?"null":"booleanValue"in n?""+n.booleanValue:"integerValue"in n?""+n.integerValue:"doubleValue"in n?""+n.doubleValue:"timestampValue"in n?function(t){const r=Bt(t);return`time(${r.seconds},${r.nanos})`}(n.timestampValue):"stringValue"in n?n.stringValue:"bytesValue"in n?function(t){return qt(t).toBase64()}(n.bytesValue):"referenceValue"in n?function(t){return x.fromName(t).toString()}(n.referenceValue):"geoPointValue"in n?function(t){return`geo(${t.latitude},${t.longitude})`}(n.geoPointValue):"arrayValue"in n?function(t){let r="[",s=!0;for(const i of t.values||[])s?s=!1:r+=",",r+=lo(i);return r+"]"}(n.arrayValue):"mapValue"in n?function(t){const r=Object.keys(t.fields||{}).sort();let s="{",i=!0;for(const a of r)i?i=!1:s+=",",s+=`${a}:${lo(t.fields[a])}`;return s+"}"}(n.mapValue):q(61005,{value:n})}function As(n){switch($t(n)){case 0:case 1:return 4;case 2:return 8;case 3:case 8:return 16;case 4:const e=ri(n);return e?16+As(e):16;case 5:return 2*n.stringValue.length;case 6:return qt(n.bytesValue).approximateByteSize();case 7:return n.referenceValue.length;case 9:return function(r){return(r.values||[]).reduce((s,i)=>s+As(i),0)}(n.arrayValue);case 10:case 11:return function(r){let s=0;return hn(r.fields,(i,a)=>{s+=i.length+As(a)}),s}(n.mapValue);default:throw q(13486,{value:n})}}function Xc(n,e){return{referenceValue:`projects/${n.projectId}/databases/${n.database}/documents/${e.path.canonicalString()}`}}function ho(n){return!!n&&"integerValue"in n}function Mo(n){return!!n&&"arrayValue"in n}function Jc(n){return!!n&&"nullValue"in n}function Zc(n){return!!n&&"doubleValue"in n&&isNaN(Number(n.doubleValue))}function vs(n){return!!n&&"mapValue"in n}function km(n){var t,r;return((r=(((t=n==null?void 0:n.mapValue)==null?void 0:t.fields)||{})[Fl])==null?void 0:r.stringValue)===Ul}function Sr(n){if(n.geoPointValue)return{geoPointValue:{...n.geoPointValue}};if(n.timestampValue&&typeof n.timestampValue=="object")return{timestampValue:{...n.timestampValue}};if(n.mapValue){const e={mapValue:{fields:{}}};return hn(n.mapValue.fields,(t,r)=>e.mapValue.fields[t]=Sr(r)),e}if(n.arrayValue){const e={arrayValue:{values:[]}};for(let t=0;t<(n.arrayValue.values||[]).length;++t)e.arrayValue.values[t]=Sr(n.arrayValue.values[t]);return e}return{...n}}function Dm(n){return(((n.mapValue||{}).fields||{}).__type__||{}).stringValue===Nm}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $e{constructor(e){this.value=e}static empty(){return new $e({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let r=0;r<e.length-1;++r)if(t=(t.mapValue.fields||{})[e.get(r)],!vs(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=Sr(t)}setAll(e){let t=Pe.emptyPath(),r={},s=[];e.forEach((a,u)=>{if(!t.isImmediateParentOf(u)){const l=this.getFieldsMap(t);this.applyChanges(l,r,s),r={},s=[],t=u.popLast()}a?r[u.lastSegment()]=Sr(a):s.push(u.lastSegment())});const i=this.getFieldsMap(t);this.applyChanges(i,r,s)}delete(e){const t=this.field(e.popLast());vs(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return at(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let r=0;r<e.length;++r){let s=t.mapValue.fields[e.get(r)];vs(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},t.mapValue.fields[e.get(r)]=s),t=s}return t.mapValue.fields}applyChanges(e,t,r){hn(t,(s,i)=>e[s]=i);for(const s of r)delete e[s]}clone(){return new $e(Sr(this.value))}}function Bl(n){const e=[];return hn(n.fields,(t,r)=>{const s=new Pe([t]);if(vs(r)){const i=Bl(r.mapValue).fields;if(i.length===0)e.push(s);else for(const a of i)e.push(s.child(a))}else e.push(s)}),new We(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fs{constructor(e,t){this.position=e,this.inclusive=t}}function eu(n,e,t){let r=0;for(let s=0;s<n.position.length;s++){const i=e[s],a=n.position[s];if(i.field.isKeyField()?r=x.comparator(x.fromName(a.referenceValue),t.key):r=xn(a,t.data.field(i.field)),i.dir==="desc"&&(r*=-1),r!==0)break}return r}function tu(n,e){if(n===null)return e===null;if(e===null||n.inclusive!==e.inclusive||n.position.length!==e.position.length)return!1;for(let t=0;t<n.position.length;t++)if(!at(n.position[t],e.position[t]))return!1;return!0}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ur{constructor(e,t="asc"){this.field=e,this.dir=t}}function Vm(n,e){return n.dir===e.dir&&n.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Km=new de(x.comparator);function mt(){return Km}const Yl=new de(x.comparator);function Tr(...n){let e=Yl;for(const t of n)e=e.insert(t.key,t);return e}function Xl(n){let e=Yl;return n.forEach((t,r)=>e=e.insert(t,r.overlayedDocument)),e}function en(){return br()}function Jl(){return br()}function br(){return new dn(n=>n.toString(),(n,e)=>n.isEqual(e))}const Qm=new de(x.comparator),Ym=new we(x.comparator);function ee(...n){let e=Ym;for(const t of n)e=e.add(t);return e}const Xm=new we(Z);function Jm(){return Xm}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oi{constructor(){this._=void 0}}function eg(n,e,t){return n instanceof Br?function(s,i){const a={fields:{[Ll]:{stringValue:Vl},[xl]:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&Lo(i)&&(i=ri(i)),i&&(a.fields[Ml]=i),{mapValue:a}}(t,e):n instanceof qr?th(n,e):n instanceof $r?nh(n,e):function(s,i){const a=eh(s,i),u=su(a)+su(s.Ae);return ho(a)&&ho(s.Ae)?Zl(u):Bo(s.serializer,u)}(n,e)}function tg(n,e,t){return n instanceof qr?th(n,e):n instanceof $r?nh(n,e):t}function eh(n,e){return n instanceof Bs?function(r){return ho(r)||function(i){return!!i&&"doubleValue"in i}(r)}(e)?e:{integerValue:0}:null}class Br extends oi{}class qr extends oi{constructor(e){super(),this.elements=e}}function th(n,e){const t=rh(e);for(const r of n.elements)t.some(s=>at(s,r))||t.push(r);return{arrayValue:{values:t}}}class $r extends oi{constructor(e){super(),this.elements=e}}function nh(n,e){let t=rh(e);for(const r of n.elements)t=t.filter(s=>!at(s,r));return{arrayValue:{values:t}}}class Bs extends oi{constructor(e,t){super(),this.serializer=e,this.Ae=t}}function su(n){return me(n.integerValue||n.doubleValue)}function rh(n){return Mo(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ng{constructor(e,t){this.field=e,this.transform=t}}function rg(n,e){return n.field.isEqual(e.field)&&function(r,s){return r instanceof qr&&s instanceof qr||r instanceof $r&&s instanceof $r?Mn(r.elements,s.elements,at):r instanceof Bs&&s instanceof Bs?at(r.Ae,s.Ae):r instanceof Br&&s instanceof Br}(n.transform,e.transform)}class sg{constructor(e,t){this.version=e,this.transformResults=t}}class dt{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new dt}static exists(e){return new dt(void 0,e)}static updateTime(e){return new dt(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function Rs(n,e){return n.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(n.updateTime):n.exists===void 0||n.exists===e.isFoundDocument()}class ai{}function sh(n,e){if(!n.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return n.isNoDocument()?new oh(n.key,dt.none()):new Kr(n.key,n.data,dt.none());{const t=n.data,r=$e.empty();let s=new we(Pe.comparator);for(let i of e.fields)if(!s.has(i)){let a=t.field(i);a===null&&i.length>1&&(i=i.popLast(),a=t.field(i)),a===null?r.delete(i):r.set(i,a),s=s.add(i)}return new fn(n.key,r,new We(s.toArray()),dt.none())}}function ig(n,e,t){n instanceof Kr?function(s,i,a){const u=s.value.clone(),l=ou(s.fieldTransforms,i,a.transformResults);u.setAll(l),i.convertToFoundDocument(a.version,u).setHasCommittedMutations()}(n,e,t):n instanceof fn?function(s,i,a){if(!Rs(s.precondition,i))return void i.convertToUnknownDocument(a.version);const u=ou(s.fieldTransforms,i,a.transformResults),l=i.data;l.setAll(ih(s)),l.setAll(u),i.convertToFoundDocument(a.version,l).setHasCommittedMutations()}(n,e,t):function(s,i,a){i.convertToNoDocument(a.version).setHasCommittedMutations()}(0,e,t)}function Cr(n,e,t,r){return n instanceof Kr?function(i,a,u,l){if(!Rs(i.precondition,a))return u;const d=i.value.clone(),f=au(i.fieldTransforms,l,a);return d.setAll(f),a.convertToFoundDocument(a.version,d).setHasLocalMutations(),null}(n,e,t,r):n instanceof fn?function(i,a,u,l){if(!Rs(i.precondition,a))return u;const d=au(i.fieldTransforms,l,a),f=a.data;return f.setAll(ih(i)),f.setAll(d),a.convertToFoundDocument(a.version,f).setHasLocalMutations(),u===null?null:u.unionWith(i.fieldMask.fields).unionWith(i.fieldTransforms.map(m=>m.field))}(n,e,t,r):function(i,a,u){return Rs(i.precondition,a)?(a.convertToNoDocument(a.version).setHasLocalMutations(),null):u}(n,e,t)}function og(n,e){let t=null;for(const r of n.fieldTransforms){const s=e.data.field(r.field),i=eh(r.transform,s||null);i!=null&&(t===null&&(t=$e.empty()),t.set(r.field,i))}return t||null}function iu(n,e){return n.type===e.type&&!!n.key.isEqual(e.key)&&!!n.precondition.isEqual(e.precondition)&&!!function(r,s){return r===void 0&&s===void 0||!(!r||!s)&&Mn(r,s,(i,a)=>rg(i,a))}(n.fieldTransforms,e.fieldTransforms)&&(n.type===0?n.value.isEqual(e.value):n.type!==1||n.data.isEqual(e.data)&&n.fieldMask.isEqual(e.fieldMask))}class Kr extends ai{constructor(e,t,r,s=[]){super(),this.key=e,this.value=t,this.precondition=r,this.fieldTransforms=s,this.type=0}getFieldMask(){return null}}class fn extends ai{constructor(e,t,r,s,i=[]){super(),this.key=e,this.data=t,this.fieldMask=r,this.precondition=s,this.fieldTransforms=i,this.type=1}getFieldMask(){return this.fieldMask}}function ih(n){const e=new Map;return n.fieldMask.fields.forEach(t=>{if(!t.isEmpty()){const r=n.data.field(t);e.set(t,r)}}),e}function ou(n,e,t){const r=new Map;se(n.length===t.length,32656,{Re:t.length,Ve:n.length});for(let s=0;s<t.length;s++){const i=n[s],a=i.transform,u=e.data.field(i.field);r.set(i.field,tg(a,u,t[s]))}return r}function au(n,e,t){const r=new Map;for(const s of n){const i=s.transform,a=t.data.field(s.field);r.set(s.field,eg(i,a,e))}return r}class oh extends ai{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class ag extends ai{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ci{constructor(e,t,r,s,i){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,t,r){const s=new Map;return s.set(e,Qr.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new ci($.min(),s,new de(Z),mt(),ee())}}class Qr{constructor(e,t,r,s,i){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new Qr(r,t,ee(),ee(),ee())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ss{constructor(e,t,r,s){this.be=e,this.removedTargetIds=t,this.key=r,this.De=s}}class ch{constructor(e,t){this.targetId=e,this.Ce=t}}class uh{constructor(e,t,r=be.EMPTY_BYTE_STRING,s=null){this.state=e,this.targetIds=t,this.resumeToken=r,this.cause=s}}class lu{constructor(){this.ve=0,this.Fe=hu(),this.Me=be.EMPTY_BYTE_STRING,this.xe=!1,this.Oe=!0}get current(){return this.xe}get resumeToken(){return this.Me}get Ne(){return this.ve!==0}get Be(){return this.Oe}Le(e){e.approximateByteSize()>0&&(this.Oe=!0,this.Me=e)}ke(){let e=ee(),t=ee(),r=ee();return this.Fe.forEach((s,i)=>{switch(i){case 0:e=e.add(s);break;case 2:t=t.add(s);break;case 1:r=r.add(s);break;default:q(38017,{changeType:i})}}),new Qr(this.Me,this.xe,e,t,r)}qe(){this.Oe=!1,this.Fe=hu()}Qe(e,t){this.Oe=!0,this.Fe=this.Fe.insert(e,t)}$e(e){this.Oe=!0,this.Fe=this.Fe.remove(e)}Ue(){this.ve+=1}Ke(){this.ve-=1,se(this.ve>=0,3241,{ve:this.ve})}We(){this.Oe=!0,this.xe=!0}}class pg{constructor(e){this.Ge=e,this.ze=new Map,this.je=mt(),this.Je=Es(),this.He=Es(),this.Ye=new de(Z)}Ze(e){for(const t of e.be)e.De&&e.De.isFoundDocument()?this.Xe(t,e.De):this.et(t,e.key,e.De);for(const t of e.removedTargetIds)this.et(t,e.key,e.De)}tt(e){this.forEachTarget(e,t=>{const r=this.nt(t);switch(e.state){case 0:this.rt(t)&&r.Le(e.resumeToken);break;case 1:r.Ke(),r.Ne||r.qe(),r.Le(e.resumeToken);break;case 2:r.Ke(),r.Ne||this.removeTarget(t);break;case 3:this.rt(t)&&(r.We(),r.Le(e.resumeToken));break;case 4:this.rt(t)&&(this.it(t),r.Le(e.resumeToken));break;default:q(56790,{state:e.state})}})}forEachTarget(e,t){e.targetIds.length>0?e.targetIds.forEach(t):this.ze.forEach((r,s)=>{this.rt(s)&&t(s)})}st(e){const t=e.targetId,r=e.Ce.count,s=this.ot(t);if(s){const i=s.target;if(po(i))if(r===0){const a=new x(i.path);this.et(t,a,ke.newNoDocument(a,$.min()))}else se(r===1,20013,{expectedCount:r});else{const a=this._t(t);if(a!==r){const u=this.ut(e),l=u?this.ct(u,e,a):1;if(l!==0){this.it(t);const d=l===2?"TargetPurposeExistenceFilterMismatchBloom":"TargetPurposeExistenceFilterMismatch";this.Ye=this.Ye.insert(t,d)}}}}}ut(e){const t=e.Ce.unchangedNames;if(!t||!t.bits)return null;const{bits:{bitmap:r="",padding:s=0},hashCount:i=0}=t;let a,u;try{a=qt(r).toUint8Array()}catch(l){if(l instanceof Dl)return Ln("Decoding the base64 bloom filter in existence filter failed ("+l.message+"); ignoring the bloom filter and falling back to full re-query."),null;throw l}try{u=new $o(a,s,i)}catch(l){return Ln(l instanceof wr?"BloomFilter error: ":"Applying bloom filter failed: ",l),null}return u.ge===0?null:u}ct(e,t,r){return t.Ce.count===r-this.Pt(e,t.targetId)?0:2}Pt(e,t){const r=this.Ge.getRemoteKeysForTarget(t);let s=0;return r.forEach(i=>{const a=this.Ge.ht(),u=`projects/${a.projectId}/databases/${a.database}/documents/${i.path.canonicalString()}`;e.mightContain(u)||(this.et(t,i,null),s++)}),s}Tt(e){const t=new Map;this.ze.forEach((i,a)=>{const u=this.ot(a);if(u){if(i.current&&po(u.target)){const l=new x(u.target.path);this.It(l).has(a)||this.Et(a,l)||this.et(a,l,ke.newNoDocument(l,e))}i.Be&&(t.set(a,i.ke()),i.qe())}});let r=ee();this.He.forEach((i,a)=>{let u=!0;a.forEachWhile(l=>{const d=this.ot(l);return!d||d.purpose==="TargetPurposeLimboResolution"||(u=!1,!1)}),u&&(r=r.add(i))}),this.je.forEach((i,a)=>a.setReadTime(e));const s=new ci(e,t,this.Ye,this.je,r);return this.je=mt(),this.Je=Es(),this.He=Es(),this.Ye=new de(Z),s}Xe(e,t){if(!this.rt(e))return;const r=this.Et(e,t.key)?2:0;this.nt(e).Qe(t.key,r),this.je=this.je.insert(t.key,t),this.Je=this.Je.insert(t.key,this.It(t.key).add(e)),this.He=this.He.insert(t.key,this.dt(t.key).add(e))}et(e,t,r){if(!this.rt(e))return;const s=this.nt(e);this.Et(e,t)?s.Qe(t,1):s.$e(t),this.He=this.He.insert(t,this.dt(t).delete(e)),this.He=this.He.insert(t,this.dt(t).add(e)),r&&(this.je=this.je.insert(t,r))}removeTarget(e){this.ze.delete(e)}_t(e){const t=this.nt(e).ke();return this.Ge.getRemoteKeysForTarget(e).size+t.addedDocuments.size-t.removedDocuments.size}Ue(e){this.nt(e).Ue()}nt(e){let t=this.ze.get(e);return t||(t=new lu,this.ze.set(e,t)),t}dt(e){let t=this.He.get(e);return t||(t=new we(Z),this.He=this.He.insert(e,t)),t}It(e){let t=this.Je.get(e);return t||(t=new we(Z),this.Je=this.Je.insert(e,t)),t}rt(e){const t=this.ot(e)!==null;return t||V("WatchChangeAggregator","Detected inactive target",e),t}ot(e){const t=this.ze.get(e);return t&&t.Ne?null:this.Ge.At(e)}it(e){this.ze.set(e,new lu),this.Ge.getRemoteKeysForTarget(e).forEach(t=>{this.et(e,t,null)})}Et(e,t){return this.Ge.getRemoteKeysForTarget(e).has(t)}}function Es(){return new de(x.comparator)}function hu(){return new de(x.comparator)}const mg={asc:"ASCENDING",desc:"DESCENDING"},gg={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},_g={and:"AND",or:"OR"};class yg{constructor(e,t){this.databaseId=e,this.useProto3Json=t}}function go(n,e){return n.useProto3Json||ni(e)?e:{value:e}}function qs(n,e){return n.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function lh(n,e){return n.useProto3Json?e.toBase64():e.toUint8Array()}function Eg(n,e){return qs(n,e.toTimestamp())}function nt(n){return se(!!n,49232),$.fromTimestamp(function(t){const r=Bt(t);return new ue(r.seconds,r.nanos)}(n))}function Ho(n,e){return _o(n,e).canonicalString()}function _o(n,e){const t=function(s){return new oe(["projects",s.projectId,"databases",s.database])}(n).child("documents");return e===void 0?t:t.child(e)}function hh(n){const e=oe.fromString(n);return se(gh(e),10190,{key:e.toString()}),e}function yo(n,e){return Ho(n.databaseId,e.path)}function Qi(n,e){const t=hh(e);if(t.get(1)!==n.databaseId.projectId)throw new k(P.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+t.get(1)+" vs "+n.databaseId.projectId);if(t.get(3)!==n.databaseId.database)throw new k(P.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+t.get(3)+" vs "+n.databaseId.database);return new x(fh(t))}function dh(n,e){return Ho(n.databaseId,e)}function Ig(n){const e=hh(n);return e.length===4?oe.emptyPath():fh(e)}function Eo(n){return new oe(["projects",n.databaseId.projectId,"databases",n.databaseId.database]).canonicalString()}function fh(n){return se(n.length>4&&n.get(4)==="documents",29091,{key:n.toString()}),n.popFirst(5)}function du(n,e,t){return{name:yo(n,e),fields:t.value.mapValue.fields}}function Tg(n,e){let t;if("targetChange"in e){e.targetChange;const r=function(d){return d==="NO_CHANGE"?0:d==="ADD"?1:d==="REMOVE"?2:d==="CURRENT"?3:d==="RESET"?4:q(39313,{state:d})}(e.targetChange.targetChangeType||"NO_CHANGE"),s=e.targetChange.targetIds||[],i=function(d,f){return d.useProto3Json?(se(f===void 0||typeof f=="string",58123),be.fromBase64String(f||"")):(se(f===void 0||f instanceof Buffer||f instanceof Uint8Array,16193),be.fromUint8Array(f||new Uint8Array))}(n,e.targetChange.resumeToken),a=e.targetChange.cause,u=a&&function(d){const f=d.code===void 0?P.UNKNOWN:ah(d.code);return new k(f,d.message||"")}(a);t=new uh(r,s,i,u||null)}else if("documentChange"in e){e.documentChange;const r=e.documentChange;r.document,r.document.name,r.document.updateTime;const s=Qi(n,r.document.name),i=nt(r.document.updateTime),a=r.document.createTime?nt(r.document.createTime):$.min(),u=new $e({mapValue:{fields:r.document.fields}}),l=ke.newFoundDocument(s,i,a,u),d=r.targetIds||[],f=r.removedTargetIds||[];t=new Ss(d,f,l.key,l)}else if("documentDelete"in e){e.documentDelete;const r=e.documentDelete;r.document;const s=Qi(n,r.document),i=r.readTime?nt(r.readTime):$.min(),a=ke.newNoDocument(s,i),u=r.removedTargetIds||[];t=new Ss([],u,a.key,a)}else if("documentRemove"in e){e.documentRemove;const r=e.documentRemove;r.document;const s=Qi(n,r.document),i=r.removedTargetIds||[];t=new Ss([],i,s,null)}else{if(!("filter"in e))return q(11601,{Rt:e});{e.filter;const r=e.filter;r.targetId;const{count:s=0,unchangedNames:i}=r,a=new lg(s,i),u=r.targetId;t=new ch(u,a)}}return t}function wg(n,e){let t;if(e instanceof Kr)t={update:du(n,e.key,e.value)};else if(e instanceof oh)t={delete:yo(n,e.key)};else if(e instanceof fn)t={update:du(n,e.key,e.data),updateMask:Ng(e.fieldMask)};else{if(!(e instanceof ag))return q(16599,{Vt:e.type});t={verify:yo(n,e.key)}}return e.fieldTransforms.length>0&&(t.updateTransforms=e.fieldTransforms.map(r=>function(i,a){const u=a.transform;if(u instanceof Br)return{fieldPath:a.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(u instanceof qr)return{fieldPath:a.field.canonicalString(),appendMissingElements:{values:u.elements}};if(u instanceof $r)return{fieldPath:a.field.canonicalString(),removeAllFromArray:{values:u.elements}};if(u instanceof Bs)return{fieldPath:a.field.canonicalString(),increment:u.Ae};throw q(20930,{transform:a.transform})}(0,r))),e.precondition.isNone||(t.currentDocument=function(s,i){return i.updateTime!==void 0?{updateTime:Eg(s,i.updateTime)}:i.exists!==void 0?{exists:i.exists}:q(27497)}(n,e.precondition)),t}function Ag(n,e){return n&&n.length>0?(se(e!==void 0,14353),n.map(t=>function(s,i){let a=s.updateTime?nt(s.updateTime):nt(i);return a.isEqual($.min())&&(a=nt(i)),new sg(a,s.transformResults||[])}(t,e))):[]}function vg(n,e){return{documents:[dh(n,e.path)]}}function Rg(n,e){const t={structuredQuery:{}},r=e.path;let s;e.collectionGroup!==null?(s=r,t.structuredQuery.from=[{collectionId:e.collectionGroup,allDescendants:!0}]):(s=r.popLast(),t.structuredQuery.from=[{collectionId:r.lastSegment()}]),t.parent=dh(n,s);const i=function(d){if(d.length!==0)return mh(Ye.create(d,"and"))}(e.filters);i&&(t.structuredQuery.where=i);const a=function(d){if(d.length!==0)return d.map(f=>function(I){return{field:wn(I.field),direction:bg(I.dir)}}(f))}(e.orderBy);a&&(t.structuredQuery.orderBy=a);const u=go(n,e.limit);return u!==null&&(t.structuredQuery.limit=u),e.startAt&&(t.structuredQuery.startAt=function(d){return{before:d.inclusive,values:d.position}}(e.startAt)),e.endAt&&(t.structuredQuery.endAt=function(d){return{before:!d.inclusive,values:d.position}}(e.endAt)),{ft:t,parent:s}}function Sg(n){let e=Ig(n.parent);const t=n.structuredQuery,r=t.from?t.from.length:0;let s=null;if(r>0){se(r===1,65062);const f=t.from[0];f.allDescendants?s=f.collectionId:e=e.child(f.collectionId)}let i=[];t.where&&(i=function(m){const I=ph(m);return I instanceof Ye&&Hl(I)?I.getFilters():[I]}(t.where));let a=[];t.orderBy&&(a=function(m){return m.map(I=>function(C){return new Ur(An(C.field),function(N){switch(N){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(C.direction))}(I))}(t.orderBy));let u=null;t.limit&&(u=function(m){let I;return I=typeof m=="object"?m.value:m,ni(I)?null:I}(t.limit));let l=null;t.startAt&&(l=function(m){const I=!!m.before,S=m.values||[];return new Fs(S,I)}(t.startAt));let d=null;return t.endAt&&(d=function(m){const I=!m.before,S=m.values||[];return new Fs(S,I)}(t.endAt)),jm(e,s,a,i,u,"F",l,d)}function Pg(n,e){const t=function(s){switch(s){case"TargetPurposeListen":return null;case"TargetPurposeExistenceFilterMismatch":return"existence-filter-mismatch";case"TargetPurposeExistenceFilterMismatchBloom":return"existence-filter-mismatch-bloom";case"TargetPurposeLimboResolution":return"limbo-document";default:return q(28987,{purpose:s})}}(e.purpose);return t==null?null:{"goog-listen-tags":t}}function ph(n){return n.unaryFilter!==void 0?function(t){switch(t.unaryFilter.op){case"IS_NAN":const r=An(t.unaryFilter.field);return ye.create(r,"==",{doubleValue:NaN});case"IS_NULL":const s=An(t.unaryFilter.field);return ye.create(s,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const i=An(t.unaryFilter.field);return ye.create(i,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const a=An(t.unaryFilter.field);return ye.create(a,"!=",{nullValue:"NULL_VALUE"});case"OPERATOR_UNSPECIFIED":return q(61313);default:return q(60726)}}(n):n.fieldFilter!==void 0?function(t){return ye.create(An(t.fieldFilter.field),function(s){switch(s){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";case"OPERATOR_UNSPECIFIED":return q(58110);default:return q(50506)}}(t.fieldFilter.op),t.fieldFilter.value)}(n):n.compositeFilter!==void 0?function(t){return Ye.create(t.compositeFilter.filters.map(r=>ph(r)),function(s){switch(s){case"AND":return"and";case"OR":return"or";default:return q(1026)}}(t.compositeFilter.op))}(n):q(30097,{filter:n})}function bg(n){return mg[n]}function Cg(n){return gg[n]}function Og(n){return _g[n]}function wn(n){return{fieldPath:n.canonicalString()}}function An(n){return Pe.fromServerFormat(n.fieldPath)}function mh(n){return n instanceof ye?function(t){if(t.op==="=="){if(Zc(t.value))return{unaryFilter:{field:wn(t.field),op:"IS_NAN"}};if(Jc(t.value))return{unaryFilter:{field:wn(t.field),op:"IS_NULL"}}}else if(t.op==="!="){if(Zc(t.value))return{unaryFilter:{field:wn(t.field),op:"IS_NOT_NAN"}};if(Jc(t.value))return{unaryFilter:{field:wn(t.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:wn(t.field),op:Cg(t.op),value:t.value}}}(n):n instanceof Ye?function(t){const r=t.getFilters().map(s=>mh(s));return r.length===1?r[0]:{compositeFilter:{op:Og(t.op),filters:r}}}(n):q(54877,{filter:n})}function Ng(n){const e=[];return n.fields.forEach(t=>e.push(t.canonicalString())),{fieldPaths:e}}function gh(n){return n.length>=4&&n.get(0)==="projects"&&n.get(2)==="databases"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hg{constructor(e,t,r,s){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=r,this.indexManager=s}getDocument(e,t){let r=null;return this.documentOverlayCache.getOverlay(e,t).next(s=>(r=s,this.remoteDocumentCache.getEntry(e,t))).next(s=>(r!==null&&Cr(r.mutation,s,We.empty(),ue.now()),s))}getDocuments(e,t){return this.remoteDocumentCache.getEntries(e,t).next(r=>this.getLocalViewOfDocuments(e,r,ee()).next(()=>r))}getLocalViewOfDocuments(e,t,r=ee()){const s=en();return this.populateOverlays(e,s,t).next(()=>this.computeViews(e,t,s,r).next(i=>{let a=Tr();return i.forEach((u,l)=>{a=a.insert(u,l.overlayedDocument)}),a}))}getOverlayedDocuments(e,t){const r=en();return this.populateOverlays(e,r,t).next(()=>this.computeViews(e,t,r,ee()))}populateOverlays(e,t,r){const s=[];return r.forEach(i=>{t.has(i)||s.push(i)}),this.documentOverlayCache.getOverlays(e,s).next(i=>{i.forEach((a,u)=>{t.set(a,u)})})}computeViews(e,t,r,s){let i=mt();const a=br(),u=function(){return br()}();return t.forEach((l,d)=>{const f=r.get(d.key);s.has(d.key)&&(f===void 0||f.mutation instanceof fn)?i=i.insert(d.key,d):f!==void 0?(a.set(d.key,f.mutation.getFieldMask()),Cr(f.mutation,d,f.mutation.getFieldMask(),ue.now())):a.set(d.key,We.empty())}),this.recalculateAndSaveOverlays(e,i).next(l=>(l.forEach((d,f)=>a.set(d,f)),t.forEach((d,f)=>u.set(d,new $g(f,a.get(d)??null))),u))}recalculateAndSaveOverlays(e,t){const r=br();let s=new de((a,u)=>a-u),i=ee();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next(a=>{for(const u of a)u.keys().forEach(l=>{const d=t.get(l);if(d===null)return;let f=r.get(l)||We.empty();f=u.applyToLocalView(d,f),r.set(l,f);const m=(s.get(u.batchId)||ee()).add(l);s=s.insert(u.batchId,m)})}).next(()=>{const a=[],u=s.getReverseIterator();for(;u.hasNext();){const l=u.getNext(),d=l.key,f=l.value,m=Jl();f.forEach(I=>{if(!i.has(I)){const S=sh(t.get(I),r.get(I));S!==null&&m.set(I,S),i=i.add(I)}}),a.push(this.documentOverlayCache.saveOverlays(e,d,m))}return b.waitFor(a)}).next(()=>r)}recalculateAndSaveOverlaysForDocumentKeys(e,t){return this.remoteDocumentCache.getEntries(e,t).next(r=>this.recalculateAndSaveOverlays(e,r))}getDocumentsMatchingQuery(e,t,r,s){return function(a){return x.isDocumentKey(a.path)&&a.collectionGroup===null&&a.filters.length===0}(t)?this.getDocumentsMatchingDocumentQuery(e,t.path):Wl(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,r,s):this.getDocumentsMatchingCollectionQuery(e,t,r,s)}getNextDocuments(e,t,r,s){return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,r,s).next(i=>{const a=s-i.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,t,r.largestBatchId,s-i.size):b.resolve(en());let u=Lr,l=i;return a.next(d=>b.forEach(d,(f,m)=>(u<m.largestBatchId&&(u=m.largestBatchId),i.get(f)?b.resolve():this.remoteDocumentCache.getEntry(e,f).next(I=>{l=l.insert(f,I)}))).next(()=>this.populateOverlays(e,d,i)).next(()=>this.computeViews(e,l,d,ee())).next(f=>({batchId:u,changes:Xl(f)})))})}getDocumentsMatchingDocumentQuery(e,t){return this.getDocument(e,new x(t)).next(r=>{let s=Tr();return r.isFoundDocument()&&(s=s.insert(r.key,r)),s})}getDocumentsMatchingCollectionGroupQuery(e,t,r,s){const i=t.collectionGroup;let a=Tr();return this.indexManager.getCollectionParents(e,i).next(u=>b.forEach(u,l=>{const d=function(m,I){return new Qn(I,null,m.explicitOrderBy.slice(),m.filters.slice(),m.limit,m.limitType,m.startAt,m.endAt)}(t,l.child(i));return this.getDocumentsMatchingCollectionQuery(e,d,r,s).next(f=>{f.forEach((m,I)=>{a=a.insert(m,I)})})}).next(()=>a))}getDocumentsMatchingCollectionQuery(e,t,r,s){let i;return this.documentOverlayCache.getOverlaysForCollection(e,t.path,r.largestBatchId).next(a=>(i=a,this.remoteDocumentCache.getDocumentsMatchingQuery(e,t,r,i,s))).next(a=>{i.forEach((l,d)=>{const f=d.getKey();a.get(f)===null&&(a=a.insert(f,ke.newInvalidDocument(f)))});let u=Tr();return a.forEach((l,d)=>{const f=i.get(l);f!==void 0&&Cr(f.mutation,d,We.empty(),ue.now()),ii(t,d)&&(u=u.insert(l,d))}),u})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zg{constructor(){this.overlays=new de(x.comparator),this.qr=new Map}getOverlay(e,t){return b.resolve(this.overlays.get(t))}getOverlays(e,t){const r=en();return b.forEach(t,s=>this.getOverlay(e,s).next(i=>{i!==null&&r.set(s,i)})).next(()=>r)}saveOverlays(e,t,r){return r.forEach((s,i)=>{this.St(e,t,i)}),b.resolve()}removeOverlaysForBatchId(e,t,r){const s=this.qr.get(r);return s!==void 0&&(s.forEach(i=>this.overlays=this.overlays.remove(i)),this.qr.delete(r)),b.resolve()}getOverlaysForCollection(e,t,r){const s=en(),i=t.length+1,a=new x(t.child("")),u=this.overlays.getIteratorFrom(a);for(;u.hasNext();){const l=u.getNext().value,d=l.getKey();if(!t.isPrefixOf(d.path))break;d.path.length===i&&l.largestBatchId>r&&s.set(l.getKey(),l)}return b.resolve(s)}getOverlaysForCollectionGroup(e,t,r,s){let i=new de((d,f)=>d-f);const a=this.overlays.getIterator();for(;a.hasNext();){const d=a.getNext().value;if(d.getKey().getCollectionGroup()===t&&d.largestBatchId>r){let f=i.get(d.largestBatchId);f===null&&(f=en(),i=i.insert(d.largestBatchId,f)),f.set(d.getKey(),d)}}const u=en(),l=i.getIterator();for(;l.hasNext()&&(l.getNext().value.forEach((d,f)=>u.set(d,f)),!(u.size()>=s)););return b.resolve(u)}St(e,t,r){const s=this.overlays.get(r.key);if(s!==null){const a=this.qr.get(s.largestBatchId).delete(r.key);this.qr.set(s.largestBatchId,a)}this.overlays=this.overlays.insert(r.key,new ug(t,r));let i=this.qr.get(t);i===void 0&&(i=ee(),this.qr.set(t,i)),this.qr.set(t,i.add(r.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wg{constructor(e,t){this.indexManager=e,this.referenceDelegate=t,this.mutationQueue=[],this.tr=1,this.Zr=new we(ve.$r)}checkEmpty(e){return b.resolve(this.mutationQueue.length===0)}addMutationBatch(e,t,r,s){const i=this.tr;this.tr++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const a=new cg(i,t,r,s);this.mutationQueue.push(a);for(const u of s)this.Zr=this.Zr.add(new ve(u.key,i)),this.indexManager.addToCollectionParentIndex(e,u.key.path.popLast());return b.resolve(a)}lookupMutationBatch(e,t){return b.resolve(this.Xr(t))}getNextMutationBatchAfterBatchId(e,t){const r=t+1,s=this.ei(r),i=s<0?0:s;return b.resolve(this.mutationQueue.length>i?this.mutationQueue[i]:null)}getHighestUnacknowledgedBatchId(){return b.resolve(this.mutationQueue.length===0?Vo:this.tr-1)}getAllMutationBatches(e){return b.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,t){const r=new ve(t,0),s=new ve(t,Number.POSITIVE_INFINITY),i=[];return this.Zr.forEachInRange([r,s],a=>{const u=this.Xr(a.Yr);i.push(u)}),b.resolve(i)}getAllMutationBatchesAffectingDocumentKeys(e,t){let r=new we(Z);return t.forEach(s=>{const i=new ve(s,0),a=new ve(s,Number.POSITIVE_INFINITY);this.Zr.forEachInRange([i,a],u=>{r=r.add(u.Yr)})}),b.resolve(this.ti(r))}getAllMutationBatchesAffectingQuery(e,t){const r=t.path,s=r.length+1;let i=r;x.isDocumentKey(i)||(i=i.child(""));const a=new ve(new x(i),0);let u=new we(Z);return this.Zr.forEachWhile(l=>{const d=l.key.path;return!!r.isPrefixOf(d)&&(d.length===s&&(u=u.add(l.Yr)),!0)},a),b.resolve(this.ti(u))}ti(e){const t=[];return e.forEach(r=>{const s=this.Xr(r);s!==null&&t.push(s)}),t}removeMutationBatch(e,t){se(this.ni(t.batchId,"removed")===0,55003),this.mutationQueue.shift();let r=this.Zr;return b.forEach(t.mutations,s=>{const i=new ve(s.key,t.batchId);return r=r.delete(i),this.referenceDelegate.markPotentiallyOrphaned(e,s.key)}).next(()=>{this.Zr=r})}ir(e){}containsKey(e,t){const r=new ve(t,0),s=this.Zr.firstAfterOrEqual(r);return b.resolve(t.isEqual(s&&s.key))}performConsistencyCheck(e){return this.mutationQueue.length,b.resolve()}ni(e,t){return this.ei(e)}ei(e){return this.mutationQueue.length===0?0:e-this.mutationQueue[0].batchId}Xr(e){const t=this.ei(e);return t<0||t>=this.mutationQueue.length?null:this.mutationQueue[t]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Go{constructor(e,t,r,s){this.targetId=e,this.fromCache=t,this.Es=r,this.ds=s}static As(e,t){let r=ee(),s=ee();for(const i of t.docChanges)switch(i.type){case 0:r=r.add(i.doc.key);break;case 1:s=s.add(i.doc.key)}return new Go(e,t.fromCache,r,s)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zg{constructor(){this.Rs=!1,this.Vs=!1,this.fs=100,this.gs=function(){return $f()?8:Rm(Ve())>0?6:4}()}initialize(e,t){this.ps=e,this.indexManager=t,this.Rs=!0}getDocumentsMatchingQuery(e,t,r,s){const i={result:null};return this.ys(e,t).next(a=>{i.result=a}).next(()=>{if(!i.result)return this.ws(e,t,s,r).next(a=>{i.result=a})}).next(()=>{if(i.result)return;const a=new Jg;return this.Ss(e,t,a).next(u=>{if(i.result=u,this.Vs)return this.bs(e,t,a,u.size)})}).next(()=>i.result)}bs(e,t,r,s){return r.documentReadCount<this.fs?(In()<=J.DEBUG&&V("QueryEngine","SDK will not create cache indexes for query:",Tn(t),"since it only creates cache indexes for collection contains","more than or equal to",this.fs,"documents"),b.resolve()):(In()<=J.DEBUG&&V("QueryEngine","Query:",Tn(t),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.gs*s?(In()<=J.DEBUG&&V("QueryEngine","The SDK decides to create cache indexes for query:",Tn(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,tt(t))):b.resolve())}ys(e,t){if(ru(t))return b.resolve(null);let r=tt(t);return this.indexManager.getIndexType(e,r).next(s=>s===0?null:(t.limit!==null&&s===1&&(t=Us(t,null,"F"),r=tt(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next(i=>{const a=ee(...i);return this.ps.getDocuments(e,a).next(u=>this.indexManager.getMinOffset(e,r).next(l=>{const d=this.Ds(t,u);return this.Cs(t,d,a,l.readTime)?this.ys(e,Us(t,null,"F")):this.vs(e,d,t,l)}))})))}ws(e,t,r,s){return ru(t)||s.isEqual($.min())?b.resolve(null):this.ps.getDocuments(e,r).next(i=>{const a=this.Ds(t,i);return this.Cs(t,a,r,s)?b.resolve(null):(In()<=J.DEBUG&&V("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),Tn(t)),this.vs(e,a,t,Im(s,Lr)).next(u=>u))})}Ds(e,t){let r=new we(Ql(e));return t.forEach((s,i)=>{ii(e,i)&&(r=r.add(i))}),r}Cs(e,t,r,s){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const i=e.limitType==="F"?t.last():t.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}Ss(e,t,r){return In()<=J.DEBUG&&V("QueryEngine","Using full collection scan to execute query:",Tn(t)),this.ps.getDocumentsMatchingQuery(e,t,Ut.min(),r)}vs(e,t,r,s){return this.ps.getDocumentsMatchingQuery(e,r,s).next(i=>(t.forEach(a=>{i=i.insert(a.key,a)}),i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yi="RestConnection",h_={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};class d_{get $o(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",r=encodeURIComponent(this.databaseId.projectId),s=encodeURIComponent(this.databaseId.database);this.Uo=t+"://"+e.host,this.Ko=`projects/${r}/databases/${s}`,this.Wo=this.databaseId.database===Ms?`project_id=${r}`:`project_id=${r}&database_id=${s}`}Go(e,t,r,s,i){const a=To(),u=this.zo(e,t.toUriEncodedString());V(Yi,`Sending RPC '${e}' ${a}:`,u,r);const l={"google-cloud-resource-prefix":this.Ko,"x-goog-request-params":this.Wo};this.jo(l,s,i);const{host:d}=new URL(u),f=jn(d);return this.Jo(e,u,l,r,f).then(m=>(V(Yi,`Received RPC '${e}' ${a}: `,m),m),m=>{throw Ln(Yi,`RPC '${e}' ${a} failed with error: `,m,"url: ",u,"request:",r),m})}Ho(e,t,r,s,i,a){return this.Go(e,t,r,s,i)}jo(e,t,r){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+Gn}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((s,i)=>e[i]=s),r&&r.headers.forEach((s,i)=>e[i]=s)}zo(e,t){const r=h_[e];return`${this.Uo}/v1/${t}:${r}`}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oe="WebChannelConnection";class p_ extends d_{constructor(e){super(e),this.c_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,t,r,s,i){const a=To();return new Promise((u,l)=>{const d=new wl;d.setWithCredentials(!0),d.listenOnce(Al.COMPLETE,()=>{try{switch(d.getLastErrorCode()){case ws.NO_ERROR:const m=d.getResponseJson();V(Oe,`XHR for RPC '${e}' ${a} received:`,JSON.stringify(m)),u(m);break;case ws.TIMEOUT:V(Oe,`RPC '${e}' ${a} timed out`),l(new k(P.DEADLINE_EXCEEDED,"Request time out"));break;case ws.HTTP_ERROR:const I=d.getStatus();if(V(Oe,`RPC '${e}' ${a} failed with status:`,I,"response text:",d.getResponseText()),I>0){let S=d.getResponseJson();Array.isArray(S)&&(S=S[0]);const C=S==null?void 0:S.error;if(C&&C.status&&C.message){const D=function(F){const L=F.toLowerCase().replace(/_/g,"-");return Object.values(P).indexOf(L)>=0?L:P.UNKNOWN}(C.status);l(new k(D,C.message))}else l(new k(P.UNKNOWN,"Server responded with status "+d.getStatus()))}else l(new k(P.UNAVAILABLE,"Connection failed."));break;default:q(9055,{l_:e,streamId:a,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{V(Oe,`RPC '${e}' ${a} completed.`)}});const f=JSON.stringify(s);V(Oe,`RPC '${e}' ${a} sending request:`,s),d.send(t,"POST",f,r,15)})}T_(e,t,r){const s=To(),i=[this.Uo,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=Sl(),u=Rl(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(l.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(l.useFetchStreams=!0),this.jo(l.initMessageHeaders,t,r),l.encodeInitMessageHeaders=!0;const f=i.join("");V(Oe,`Creating RPC '${e}' stream ${s}: ${f}`,l);const m=a.createWebChannel(f,l);this.I_(m);let I=!1,S=!1;const C=new f_({Yo:N=>{S?V(Oe,`Not sending because RPC '${e}' stream ${s} is closed:`,N):(I||(V(Oe,`Opening RPC '${e}' stream ${s} transport.`),m.open(),I=!0),V(Oe,`RPC '${e}' stream ${s} sending:`,N),m.send(N))},Zo:()=>m.close()}),D=(N,F,L)=>{N.listen(F,U=>{try{L(U)}catch(Y){setTimeout(()=>{throw Y},0)}})};return D(m,Ir.EventType.OPEN,()=>{S||(V(Oe,`RPC '${e}' stream ${s} transport opened.`),C.o_())}),D(m,Ir.EventType.CLOSE,()=>{S||(S=!0,V(Oe,`RPC '${e}' stream ${s} transport closed`),C.a_(),this.E_(m))}),D(m,Ir.EventType.ERROR,N=>{S||(S=!0,Ln(Oe,`RPC '${e}' stream ${s} transport errored. Name:`,N.name,"Message:",N.message),C.a_(new k(P.UNAVAILABLE,"The operation could not be completed")))}),D(m,Ir.EventType.MESSAGE,N=>{var F;if(!S){const L=N.data[0];se(!!L,16349);const U=L,Y=(U==null?void 0:U.error)||((F=U[0])==null?void 0:F.error);if(Y){V(Oe,`RPC '${e}' stream ${s} received error:`,Y);const K=Y.status;let Q=function(y){const w=_e[y];if(w!==void 0)return ah(w)}(K),E=Y.message;Q===void 0&&(Q=P.INTERNAL,E="Unknown error status: "+K+" with message "+Y.message),S=!0,C.a_(new k(Q,E)),m.close()}else V(Oe,`RPC '${e}' stream ${s} received:`,L),C.u_(L)}}),D(u,vl.STAT_EVENT,N=>{N.stat===co.PROXY?V(Oe,`RPC '${e}' stream ${s} detected buffering proxy`):N.stat===co.NOPROXY&&V(Oe,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{C.__()},0),C}terminate(){this.c_.forEach(e=>e.close()),this.c_=[]}I_(e){this.c_.push(e)}E_(e){this.c_=this.c_.filter(t=>t===e)}}function Xi(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wu{constructor(){this.ga=new de(x.comparator)}track(e){const t=e.doc.key,r=this.ga.get(t);r?e.type!==0&&r.type===3?this.ga=this.ga.insert(t,e):e.type===3&&r.type!==1?this.ga=this.ga.insert(t,{type:r.type,doc:e.doc}):e.type===2&&r.type===2?this.ga=this.ga.insert(t,{type:2,doc:e.doc}):e.type===2&&r.type===0?this.ga=this.ga.insert(t,{type:0,doc:e.doc}):e.type===1&&r.type===0?this.ga=this.ga.remove(t):e.type===1&&r.type===2?this.ga=this.ga.insert(t,{type:1,doc:r.doc}):e.type===0&&r.type===1?this.ga=this.ga.insert(t,{type:2,doc:e.doc}):q(63341,{Rt:e,pa:r}):this.ga=this.ga.insert(t,e)}ya(){const e=[];return this.ga.inorderTraversal((t,r)=>{e.push(r)}),e}}class Bn{constructor(e,t,r,s,i,a,u,l,d){this.query=e,this.docs=t,this.oldDocs=r,this.docChanges=s,this.mutatedKeys=i,this.fromCache=a,this.syncStateChanged=u,this.excludesMetadataChanges=l,this.hasCachedResults=d}static fromInitialDocuments(e,t,r,s,i){const a=[];return t.forEach(u=>{a.push({type:0,doc:u})}),new Bn(e,t,bn.emptySet(t),a,r,s,!0,!1,i)}get hasPendingWrites(){return!this.mutatedKeys.isEmpty()}isEqual(e){if(!(this.fromCache===e.fromCache&&this.hasCachedResults===e.hasCachedResults&&this.syncStateChanged===e.syncStateChanged&&this.mutatedKeys.isEqual(e.mutatedKeys)&&si(this.query,e.query)&&this.docs.isEqual(e.docs)&&this.oldDocs.isEqual(e.oldDocs)))return!1;const t=this.docChanges,r=e.docChanges;if(t.length!==r.length)return!1;for(let s=0;s<t.length;s++)if(t[s].type!==r[s].type||!t[s].doc.isEqual(r[s].doc))return!1;return!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kh{constructor(e){this.key=e}}class Dh{constructor(e){this.key=e}}class M_{constructor(e,t){this.query=e,this.Ya=t,this.Za=null,this.hasCachedResults=!1,this.current=!1,this.Xa=ee(),this.mutatedKeys=ee(),this.eu=Ql(e),this.tu=new bn(this.eu)}get nu(){return this.Ya}ru(e,t){const r=t?t.iu:new wu,s=t?t.tu:this.tu;let i=t?t.mutatedKeys:this.mutatedKeys,a=s,u=!1;const l=this.query.limitType==="F"&&s.size===this.query.limit?s.last():null,d=this.query.limitType==="L"&&s.size===this.query.limit?s.first():null;if(e.inorderTraversal((f,m)=>{const I=s.get(f),S=ii(this.query,m)?m:null,C=!!I&&this.mutatedKeys.has(I.key),D=!!S&&(S.hasLocalMutations||this.mutatedKeys.has(S.key)&&S.hasCommittedMutations);let N=!1;I&&S?I.data.isEqual(S.data)?C!==D&&(r.track({type:3,doc:S}),N=!0):this.su(I,S)||(r.track({type:2,doc:S}),N=!0,(l&&this.eu(S,l)>0||d&&this.eu(S,d)<0)&&(u=!0)):!I&&S?(r.track({type:0,doc:S}),N=!0):I&&!S&&(r.track({type:1,doc:I}),N=!0,(l||d)&&(u=!0)),N&&(S?(a=a.add(S),i=D?i.add(f):i.delete(f)):(a=a.delete(f),i=i.delete(f)))}),this.query.limit!==null)for(;a.size>this.query.limit;){const f=this.query.limitType==="F"?a.last():a.first();a=a.delete(f.key),i=i.delete(f.key),r.track({type:1,doc:f})}return{tu:a,iu:r,Cs:u,mutatedKeys:i}}su(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,r,s){const i=this.tu;this.tu=e.tu,this.mutatedKeys=e.mutatedKeys;const a=e.iu.ya();a.sort((f,m)=>function(S,C){const D=N=>{switch(N){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return q(20277,{Rt:N})}};return D(S)-D(C)}(f.type,m.type)||this.eu(f.doc,m.doc)),this.ou(r),s=s??!1;const u=t&&!s?this._u():[],l=this.Xa.size===0&&this.current&&!s?1:0,d=l!==this.Za;return this.Za=l,a.length!==0||d?{snapshot:new Bn(this.query,e.tu,i,a,e.mutatedKeys,l===0,d,!1,!!r&&r.resumeToken.approximateByteSize()>0),au:u}:{au:u}}va(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({tu:this.tu,iu:new wu,mutatedKeys:this.mutatedKeys,Cs:!1},!1)):{au:[]}}uu(e){return!this.Ya.has(e)&&!!this.tu.has(e)&&!this.tu.get(e).hasLocalMutations}ou(e){e&&(e.addedDocuments.forEach(t=>this.Ya=this.Ya.add(t)),e.modifiedDocuments.forEach(t=>{}),e.removedDocuments.forEach(t=>this.Ya=this.Ya.delete(t)),this.current=e.current)}_u(){if(!this.current)return[];const e=this.Xa;this.Xa=ee(),this.tu.forEach(r=>{this.uu(r.key)&&(this.Xa=this.Xa.add(r.key))});const t=[];return e.forEach(r=>{this.Xa.has(r)||t.push(new Dh(r))}),this.Xa.forEach(r=>{e.has(r)||t.push(new kh(r))}),t}cu(e){this.Ya=e.Qs,this.Xa=ee();const t=this.ru(e.documents);return this.applyChanges(t,!0)}lu(){return Bn.fromInitialDocuments(this.query,this.tu,this.mutatedKeys,this.Za===0,this.hasCachedResults)}}const ta="SyncEngine";class x_{constructor(e,t,r){this.query=e,this.targetId=t,this.view=r}}class F_{constructor(e){this.key=e,this.hu=!1}}class U_{constructor(e,t,r,s,i,a){this.localStore=e,this.remoteStore=t,this.eventManager=r,this.sharedClientState=s,this.currentUser=i,this.maxConcurrentLimboResolutions=a,this.Pu={},this.Tu=new dn(u=>Kl(u),si),this.Iu=new Map,this.Eu=new Set,this.du=new de(x.comparator),this.Au=new Map,this.Ru=new jo,this.Vu={},this.mu=new Map,this.fu=Un.cr(),this.onlineState="Unknown",this.gu=void 0}get isPrimaryClient(){return this.gu===!0}}async function B_(n,e,t=!0){const r=Uh(n);let s;const i=r.Tu.get(e);return i?(r.sharedClientState.addLocalQueryTarget(i.targetId),s=i.view.lu()):s=await Vh(r,e,t,!0),s}async function q_(n,e){const t=Uh(n);await Vh(t,e,!0,!1)}async function Vh(n,e,t,r){const s=await a_(n.localStore,tt(e)),i=s.targetId,a=n.sharedClientState.addLocalQueryTarget(i,t);let u;return r&&(u=await $_(n,e,i,a==="current",s.resumeToken)),n.isPrimaryClient&&t&&Ah(n.remoteStore,s),u}async function $_(n,e,t,r,s){n.pu=(m,I,S)=>async function(D,N,F,L){let U=N.view.ru(F);U.Cs&&(U=await gu(D.localStore,N.query,!1).then(({documents:E})=>N.view.ru(E,U)));const Y=L&&L.targetChanges.get(N.targetId),K=L&&L.targetMismatches.get(N.targetId)!=null,Q=N.view.applyChanges(U,D.isPrimaryClient,Y,K);return Su(D,N.targetId,Q.au),Q.snapshot}(n,m,I,S);const i=await gu(n.localStore,e,!0),a=new M_(e,i.Qs),u=a.ru(i.documents),l=Qr.createSynthesizedTargetChangeForCurrentChange(t,r&&n.onlineState!=="Offline",s),d=a.applyChanges(u,n.isPrimaryClient,l);Su(n,t,d.au);const f=new x_(e,t,a);return n.Tu.set(e,f),n.Iu.has(t)?n.Iu.get(t).push(e):n.Iu.set(t,[e]),d.snapshot}async function H_(n,e,t){const r=H(n),s=r.Tu.get(e),i=r.Iu.get(s.targetId);if(i.length>1)return r.Iu.set(s.targetId,i.filter(a=>!si(a,e))),void r.Tu.delete(e);r.isPrimaryClient?(r.sharedClientState.removeLocalQueryTarget(s.targetId),r.sharedClientState.isActiveQueryTarget(s.targetId)||await Io(r.localStore,s.targetId,!1).then(()=>{r.sharedClientState.clearQueryState(s.targetId),t&&Ko(r.remoteStore,s.targetId),Ao(r,s.targetId)}).catch(Wn)):(Ao(r,s.targetId),await Io(r.localStore,s.targetId,!0))}async function j_(n,e){const t=H(n),r=t.Tu.get(e),s=t.Iu.get(r.targetId);t.isPrimaryClient&&s.length===1&&(t.sharedClientState.removeLocalQueryTarget(r.targetId),Ko(t.remoteStore,r.targetId))}async function z_(n,e,t){const r=J_(n);try{const s=await function(a,u){const l=H(a),d=ue.now(),f=u.reduce((S,C)=>S.add(C.key),ee());let m,I;return l.persistence.runTransaction("Locally write mutations","readwrite",S=>{let C=mt(),D=ee();return l.Ns.getEntries(S,f).next(N=>{C=N,C.forEach((F,L)=>{L.isValidDocument()||(D=D.add(F))})}).next(()=>l.localDocuments.getOverlayedDocuments(S,C)).next(N=>{m=N;const F=[];for(const L of u){const U=og(L,m.get(L.key).overlayedDocument);U!=null&&F.push(new fn(L.key,U,Bl(U.value.mapValue),dt.exists(!0)))}return l.mutationQueue.addMutationBatch(S,d,F,u)}).next(N=>{I=N;const F=N.applyToLocalDocumentSet(m,D);return l.documentOverlayCache.saveOverlays(S,N.batchId,F)})}).then(()=>({batchId:I.batchId,changes:Xl(m)}))}(r.localStore,e);r.sharedClientState.addPendingMutation(s.batchId),function(a,u,l){let d=a.Vu[a.currentUser.toKey()];d||(d=new de(Z)),d=d.insert(u,l),a.Vu[a.currentUser.toKey()]=d}(r,s.batchId,t),await Xr(r,s.changes),await hi(r.remoteStore)}catch(s){const i=Zo(s,"Failed to persist write");t.reject(i)}}async function Lh(n,e){const t=H(n);try{const r=await s_(t.localStore,e);e.targetChanges.forEach((s,i)=>{const a=t.Au.get(i);a&&(se(s.addedDocuments.size+s.modifiedDocuments.size+s.removedDocuments.size<=1,22616),s.addedDocuments.size>0?a.hu=!0:s.modifiedDocuments.size>0?se(a.hu,14607):s.removedDocuments.size>0&&(se(a.hu,42227),a.hu=!1))}),await Xr(t,r,e)}catch(r){await Wn(r)}}function Ru(n,e,t){const r=H(n);if(r.isPrimaryClient&&t===0||!r.isPrimaryClient&&t===1){const s=[];r.Tu.forEach((i,a)=>{const u=a.view.va(e);u.snapshot&&s.push(u.snapshot)}),function(a,u){const l=H(a);l.onlineState=u;let d=!1;l.queries.forEach((f,m)=>{for(const I of m.Sa)I.va(u)&&(d=!0)}),d&&ea(l)}(r.eventManager,e),s.length&&r.Pu.H_(s),r.onlineState=e,r.isPrimaryClient&&r.sharedClientState.setOnlineState(e)}}async function G_(n,e,t){const r=H(n);r.sharedClientState.updateQueryState(e,"rejected",t);const s=r.Au.get(e),i=s&&s.key;if(i){let a=new de(x.comparator);a=a.insert(i,ke.newNoDocument(i,$.min()));const u=ee().add(i),l=new ci($.min(),new Map,new de(Z),a,u);await Lh(r,l),r.du=r.du.remove(i),r.Au.delete(e),na(r)}else await Io(r.localStore,e,!1).then(()=>Ao(r,e,t)).catch(Wn)}async function W_(n,e){const t=H(n),r=e.batch.batchId;try{const s=await r_(t.localStore,e);xh(t,r,null),Mh(t,r),t.sharedClientState.updateMutationState(r,"acknowledged"),await Xr(t,s)}catch(s){await Wn(s)}}async function K_(n,e,t){const r=H(n);try{const s=await function(a,u){const l=H(a);return l.persistence.runTransaction("Reject batch","readwrite-primary",d=>{let f;return l.mutationQueue.lookupMutationBatch(d,u).next(m=>(se(m!==null,37113),f=m.keys(),l.mutationQueue.removeMutationBatch(d,m))).next(()=>l.mutationQueue.performConsistencyCheck(d)).next(()=>l.documentOverlayCache.removeOverlaysForBatchId(d,f,u)).next(()=>l.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(d,f)).next(()=>l.localDocuments.getDocuments(d,f))})}(r.localStore,e);xh(r,e,t),Mh(r,e),r.sharedClientState.updateMutationState(e,"rejected",t),await Xr(r,s)}catch(s){await Wn(s)}}function Mh(n,e){(n.mu.get(e)||[]).forEach(t=>{t.resolve()}),n.mu.delete(e)}function xh(n,e,t){const r=H(n);let s=r.Vu[r.currentUser.toKey()];if(s){const i=s.get(e);i&&(t?i.reject(t):i.resolve(),s=s.remove(e)),r.Vu[r.currentUser.toKey()]=s}}function Ao(n,e,t=null){n.sharedClientState.removeLocalQueryTarget(e);for(const r of n.Iu.get(e))n.Tu.delete(r),t&&n.Pu.yu(r,t);n.Iu.delete(e),n.isPrimaryClient&&n.Ru.jr(e).forEach(r=>{n.Ru.containsKey(r)||Fh(n,r)})}function Fh(n,e){n.Eu.delete(e.path.canonicalString());const t=n.du.get(e);t!==null&&(Ko(n.remoteStore,t),n.du=n.du.remove(e),n.Au.delete(t),na(n))}function Su(n,e,t){for(const r of t)r instanceof kh?(n.Ru.addReference(r.key,e),Q_(n,r)):r instanceof Dh?(V(ta,"Document no longer in limbo: "+r.key),n.Ru.removeReference(r.key,e),n.Ru.containsKey(r.key)||Fh(n,r.key)):q(19791,{wu:r})}function Q_(n,e){const t=e.key,r=t.path.canonicalString();n.du.get(t)||n.Eu.has(r)||(V(ta,"New document in limbo: "+t),n.Eu.add(r),na(n))}function na(n){for(;n.Eu.size>0&&n.du.size<n.maxConcurrentLimboResolutions;){const e=n.Eu.values().next().value;n.Eu.delete(e);const t=new x(oe.fromString(e)),r=n.fu.next();n.Au.set(r,new F_(t)),n.du=n.du.insert(t,r),Ah(n.remoteStore,new kt(tt(Uo(t.path)),r,"TargetPurposeLimboResolution",ti.ce))}}async function Xr(n,e,t){const r=H(n),s=[],i=[],a=[];r.Tu.isEmpty()||(r.Tu.forEach((u,l)=>{a.push(r.pu(l,e,t).then(d=>{var f;if((d||t)&&r.isPrimaryClient){const m=d?!d.fromCache:(f=t==null?void 0:t.targetChanges.get(l.targetId))==null?void 0:f.current;r.sharedClientState.updateQueryState(l.targetId,m?"current":"not-current")}if(d){s.push(d);const m=Go.As(l.targetId,d);i.push(m)}}))}),await Promise.all(a),r.Pu.H_(s),await async function(l,d){const f=H(l);try{await f.persistence.runTransaction("notifyLocalViewChanges","readwrite",m=>b.forEach(d,I=>b.forEach(I.Es,S=>f.persistence.referenceDelegate.addReference(m,I.targetId,S)).next(()=>b.forEach(I.ds,S=>f.persistence.referenceDelegate.removeReference(m,I.targetId,S)))))}catch(m){if(!Kn(m))throw m;V(Wo,"Failed to update sequence numbers: "+m)}for(const m of d){const I=m.targetId;if(!m.fromCache){const S=f.Ms.get(I),C=S.snapshotVersion,D=S.withLastLimboFreeSnapshotVersion(C);f.Ms=f.Ms.insert(I,D)}}}(r.localStore,i))}async function Y_(n,e){const t=H(n);if(!t.currentUser.isEqual(e)){V(ta,"User change. New user:",e.toKey());const r=await Eh(t.localStore,e);t.currentUser=e,function(i,a){i.mu.forEach(u=>{u.forEach(l=>{l.reject(new k(P.CANCELLED,a))})}),i.mu.clear()}(t,"'waitForPendingWrites' promise is rejected due to a user change."),t.sharedClientState.handleUserChange(e,r.removedBatchIds,r.addedBatchIds),await Xr(t,r.Ls)}}function X_(n,e){const t=H(n),r=t.Au.get(e);if(r&&r.hu)return ee().add(r.key);{let s=ee();const i=t.Iu.get(e);if(!i)return s;for(const a of i){const u=t.Tu.get(a);s=s.unionWith(u.view.nu)}return s}}function Uh(n){const e=H(n);return e.remoteStore.remoteSyncer.applyRemoteEvent=Lh.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=X_.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=G_.bind(null,e),e.Pu.H_=V_.bind(null,e.eventManager),e.Pu.yu=L_.bind(null,e.eventManager),e}function J_(n){const e=H(n);return e.remoteStore.remoteSyncer.applySuccessfulWrite=W_.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=K_.bind(null,e),e}class js{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=ui(e.databaseInfo.databaseId),this.sharedClientState=this.Du(e),this.persistence=this.Cu(e),await this.persistence.start(),this.localStore=this.vu(e),this.gcScheduler=this.Fu(e,this.localStore),this.indexBackfillerScheduler=this.Mu(e,this.localStore)}Fu(e,t){return null}Mu(e,t){return null}vu(e){return n_(this.persistence,new Zg,e.initialUser,this.serializer)}Cu(e){return new yh(zo.mi,this.serializer)}Du(e){return new u_}async terminate(){var e,t;(e=this.gcScheduler)==null||e.stop(),(t=this.indexBackfillerScheduler)==null||t.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}js.provider={build:()=>new js};class Z_ extends js{constructor(e){super(),this.cacheSizeBytes=e}Fu(e,t){se(this.persistence.referenceDelegate instanceof $s,46915);const r=this.persistence.referenceDelegate.garbageCollector;return new Fg(r,e.asyncQueue,t)}Cu(e){const t=this.cacheSizeBytes!==void 0?Ue.withCacheSize(this.cacheSizeBytes):Ue.DEFAULT;return new yh(r=>$s.mi(r,t),this.serializer)}}class vo{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=r=>Ru(this.syncEngine,r,1),this.remoteStore.remoteSyncer.handleCredentialChange=Y_.bind(null,this.syncEngine),await N_(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return function(){return new D_}()}createDatastore(e){const t=ui(e.databaseInfo.databaseId),r=function(i){return new p_(i)}(e.databaseInfo);return function(i,a,u,l){return new y_(i,a,u,l)}(e.authCredentials,e.appCheckCredentials,r,t)}createRemoteStore(e){return function(r,s,i,a,u){return new I_(r,s,i,a,u)}(this.localStore,this.datastore,e.asyncQueue,t=>Ru(this.syncEngine,t,0),function(){return Eu.v()?new Eu:new l_}())}createSyncEngine(e,t){return function(s,i,a,u,l,d,f){const m=new U_(s,i,a,u,l,d);return f&&(m.gu=!0),m}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}async terminate(){var e,t;await async function(s){const i=H(s);V(cn,"RemoteStore shutting down."),i.Ea.add(5),await Yr(i),i.Aa.shutdown(),i.Ra.set("Unknown")}(this.remoteStore),(e=this.datastore)==null||e.terminate(),(t=this.eventManager)==null||t.terminate()}}vo.provider={build:()=>new vo};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bh{constructor(e){this.observer=e,this.muted=!1}next(e){this.muted||this.observer.next&&this.Ou(this.observer.next,e)}error(e){this.muted||(this.observer.error?this.Ou(this.observer.error,e):pt("Uncaught Error in snapshot listener:",e.toString()))}Nu(){this.muted=!0}Ou(e,t){setTimeout(()=>{this.muted||e(t)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rt{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new k(P.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new k(P.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return Z(this._lat,e._lat)||Z(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:rt._jsonSchemaVersion}}static fromJSON(e){if(Wr(e,rt._jsonSchema))return new rt(e.latitude,e.longitude)}}rt._jsonSchemaVersion="firestore/geoPoint/1.0",rt._jsonSchema={type:Ee("string",rt._jsonSchemaVersion),latitude:Ee("number"),longitude:Ee("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class st{constructor(e){this._values=(e||[]).map(t=>t)}toArray(){return this._values.map(e=>e)}isEqual(e){return function(r,s){if(r.length!==s.length)return!1;for(let i=0;i<r.length;++i)if(r[i]!==s[i])return!1;return!0}(this._values,e._values)}toJSON(){return{type:st._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(Wr(e,st._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every(t=>typeof t=="number"))return new st(e.vectorValues);throw new k(P.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}st._jsonSchemaVersion="firestore/vectorValue/1.0",st._jsonSchema={type:Ee("string",st._jsonSchemaVersion),vectorValues:Ee("object")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ay(n,e,t){let r;return r=n?n.toFirestore(e):e,r}class Ar{constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class tn extends Xh{constructor(e,t,r,s,i,a){super(e,t,r,s,a),this._firestore=e,this._firestoreImpl=e,this.metadata=i}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const t=new Ps(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){const r=this._document.data.field(ua("DocumentSnapshot.get",e));if(r!==null)return this._userDataWriter.convertValue(r,t.serverTimestamps)}}toJSON(){if(this.metadata.hasPendingWrites)throw new k(P.FAILED_PRECONDITION,"DocumentSnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");const e=this._document,t={};return t.type=tn._jsonSchemaVersion,t.bundle="",t.bundleSource="DocumentSnapshot",t.bundleName=this._key.toString(),!e||!e.isValidDocument()||!e.isFoundDocument()?t:(this._userDataWriter.convertObjectMap(e.data.value.mapValue.fields,"previous"),t.bundle=(this._firestore,this.ref.path,"NOT SUPPORTED"),t)}}tn._jsonSchemaVersion="firestore/documentSnapshot/1.0",tn._jsonSchema={type:Ee("string",tn._jsonSchemaVersion),bundleSource:Ee("string","DocumentSnapshot"),bundleName:Ee("string"),bundle:Ee("string")};class Ps extends tn{data(e={}){return super.data(e)}}class Cn{constructor(e,t,r,s){this._firestore=e,this._userDataWriter=t,this._snapshot=s,this.metadata=new Ar(s.hasPendingWrites,s.fromCache),this.query=r}get docs(){const e=[];return this.forEach(t=>e.push(t)),e}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(e,t){this._snapshot.docs.forEach(r=>{e.call(t,new Ps(this._firestore,this._userDataWriter,r.key,r,new Ar(this._snapshot.mutatedKeys.has(r.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){const t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new k(P.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=function(s,i){if(s._snapshot.oldDocs.isEmpty()){let a=0;return s._snapshot.docChanges.map(u=>{const l=new Ps(s._firestore,s._userDataWriter,u.doc.key,u.doc,new Ar(s._snapshot.mutatedKeys.has(u.doc.key),s._snapshot.fromCache),s.query.converter);return u.doc,{type:"added",doc:l,oldIndex:-1,newIndex:a++}})}{let a=s._snapshot.oldDocs;return s._snapshot.docChanges.filter(u=>i||u.type!==3).map(u=>{const l=new Ps(s._firestore,s._userDataWriter,u.doc.key,u.doc,new Ar(s._snapshot.mutatedKeys.has(u.doc.key),s._snapshot.fromCache),s.query.converter);let d=-1,f=-1;return u.type!==0&&(d=a.indexOf(u.doc.key),a=a.delete(u.doc.key)),u.type!==1&&(a=a.add(u.doc),f=a.indexOf(u.doc.key)),{type:vy(u.type),doc:l,oldIndex:d,newIndex:f}})}}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}toJSON(){if(this.metadata.hasPendingWrites)throw new k(P.FAILED_PRECONDITION,"QuerySnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");const e={};e.type=Cn._jsonSchemaVersion,e.bundleSource="QuerySnapshot",e.bundleName=Do.newId(),this._firestore._databaseId.database,this._firestore._databaseId.projectId;const t=[],r=[],s=[];return this.docs.forEach(i=>{i._document!==null&&(t.push(i._document),r.push(this._userDataWriter.convertObjectMap(i._document.data.value.mapValue.fields,"previous")),s.push(i.ref.path))}),e.bundle=(this._firestore,this.query._query,e.bundleName,"NOT SUPPORTED"),e}}function vy(n){switch(n){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return q(61501,{type:n})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gs=new Co("@firebase/auth");function Cy(n,...e){Gs.logLevel<=J.WARN&&Gs.warn(`Auth (${zn}): ${n}`,...e)}function bs(n,...e){Gs.logLevel<=J.ERROR&&Gs.error(`Auth (${zn}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xe(n,...e){throw ga(n,...e)}function it(n,...e){return ga(n,...e)}function nd(n,e,t){const r={...by(),[e]:t};return new zr("auth","Firebase",r).create(e,{appName:n.name})}function Ft(n){return nd(n,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function ga(n,...e){if(typeof n!="string"){const t=e[0],r=[...e.slice(1)];return r[0]&&(r[0].appName=n.name),n._errorFactory.create(t,...r)}return td.create(n,...e)}function B(n,e,...t){if(!n)throw ga(e,...t)}function ut(n){const e="INTERNAL ASSERTION FAILED: "+n;throw bs(e),new Error(e)}function gt(n,e){n||ut(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jr{constructor(e,t){this.shortDelay=e,this.longDelay=t,gt(t>e,"Short delay should be less than long delay!"),this.isMobile=Mf()||Bf()}get(){return Ny()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _a(n,e){gt(n.emulator,"Emulator should always be set here");const{url:t}=n.emulator;return e?`${t}${e.startsWith("/")?e.slice(1):e}`:t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vy=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],Ly=new Jr(3e4,6e4);function mn(n,e){return n.tenantId&&!e.tenantId?{...e,tenantId:n.tenantId}:e}async function Gt(n,e,t,r,s={}){return sd(n,s,async()=>{let i={},a={};r&&(e==="GET"?a=r:i={body:JSON.stringify(r)});const u=Gr({key:n.config.apiKey,...a}).slice(1),l=await n._getAdditionalHeaders();l["Content-Type"]="application/json",n.languageCode&&(l["X-Firebase-Locale"]=n.languageCode);const d={method:e,headers:l,...i};return Ff()||(d.referrerPolicy="no-referrer"),n.emulatorConfig&&jn(n.emulatorConfig.host)&&(d.credentials="include"),rd.fetch()(await id(n,n.config.apiHost,t,u),d)})}async function sd(n,e,t){n._canInitEmulator=!1;const r={...Dy,...e};try{const s=new xy(n),i=await Promise.race([t(),s.promise]);s.clearNetworkTimeout();const a=await i.json();if("needConfirmation"in a)throw Ts(n,"account-exists-with-different-credential",a);if(i.ok&&!("errorMessage"in a))return a;{const u=i.ok?a.errorMessage:a.error.message,[l,d]=u.split(" : ");if(l==="FEDERATED_USER_ID_ALREADY_LINKED")throw Ts(n,"credential-already-in-use",a);if(l==="EMAIL_EXISTS")throw Ts(n,"email-already-in-use",a);if(l==="USER_DISABLED")throw Ts(n,"user-disabled",a);const f=r[l]||l.toLowerCase().replace(/[_\s]+/g,"-");if(d)throw nd(n,f,d);Xe(n,f)}}catch(s){if(s instanceof yt)throw s;Xe(n,"network-request-failed",{message:String(s)})}}async function pi(n,e,t,r,s={}){const i=await Gt(n,e,t,r,s);return"mfaPendingCredential"in i&&Xe(n,"multi-factor-auth-required",{_serverResponse:i}),i}async function id(n,e,t,r){const s=`${e}${t}?${r}`,i=n,a=i.config.emulator?_a(n.config,s):`${n.config.apiScheme}://${s}`;return Vy.includes(t)&&(await i._persistenceManagerAvailable,i._getPersistenceType()==="COOKIE")?i._getPersistence()._getFinalTarget(a).toString():a}function My(n){switch(n){case"ENFORCE":return"ENFORCE";case"AUDIT":return"AUDIT";case"OFF":return"OFF";default:return"ENFORCEMENT_STATE_UNSPECIFIED"}}class xy{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,r)=>{this.timer=setTimeout(()=>r(it(this.auth,"network-request-failed")),Ly.get())})}}function Ts(n,e,t){const r={appName:n.name};t.email&&(r.email=t.email),t.phoneNumber&&(r.phoneNumber=t.phoneNumber);const s=it(n,e,r);return s.customData._tokenResponse=t,s}function Uu(n){return n!==void 0&&n.enterprise!==void 0}class Fy{constructor(e){if(this.siteKey="",this.recaptchaEnforcementState=[],e.recaptchaKey===void 0)throw new Error("recaptchaKey undefined");this.siteKey=e.recaptchaKey.split("/")[3],this.recaptchaEnforcementState=e.recaptchaEnforcementState}getProviderEnforcementState(e){if(!this.recaptchaEnforcementState||this.recaptchaEnforcementState.length===0)return null;for(const t of this.recaptchaEnforcementState)if(t.provider&&t.provider===e)return My(t.enforcementState);return null}isProviderEnabled(e){return this.getProviderEnforcementState(e)==="ENFORCE"||this.getProviderEnforcementState(e)==="AUDIT"}isAnyProviderEnabled(){return this.isProviderEnabled("EMAIL_PASSWORD_PROVIDER")||this.isProviderEnabled("PHONE_PROVIDER")}}async function Uy(n,e){return Gt(n,"GET","/v2/recaptchaConfig",mn(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nr(n){if(n)try{const e=new Date(Number(n));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function qy(n,e=!1){const t=Le(n),r=await t.getIdToken(e),s=ya(r);B(s&&s.exp&&s.auth_time&&s.iat,t.auth,"internal-error");const i=typeof s.firebase=="object"?s.firebase:void 0,a=i==null?void 0:i.sign_in_provider;return{claims:s,token:r,authTime:Nr(eo(s.auth_time)),issuedAtTime:Nr(eo(s.iat)),expirationTime:Nr(eo(s.exp)),signInProvider:a||null,signInSecondFactor:(i==null?void 0:i.sign_in_second_factor)||null}}function eo(n){return Number(n)*1e3}function ya(n){const[e,t,r]=n.split(".");if(e===void 0||t===void 0||r===void 0)return bs("JWT malformed, contained fewer than 3 sections"),null;try{const s=ul(t);return s?JSON.parse(s):(bs("Failed to decode base64 JWT payload"),null)}catch(s){return bs("Caught error parsing JWT payload as JSON",s==null?void 0:s.toString()),null}}function Bu(n){const e=ya(n);return B(e,"internal-error"),B(typeof e.exp<"u","internal-error"),B(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Hr(n,e,t=!1){if(t)return e;try{return await e}catch(r){throw r instanceof yt&&$y(r)&&n.auth.currentUser===n&&await n.auth.signOut(),r}}function $y({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ks(n){var m;const e=n.auth,t=await n.getIdToken(),r=await Hr(n,Ws(e,{idToken:t}));B(r==null?void 0:r.users.length,e,"internal-error");const s=r.users[0];n._notifyReloadListener(s);const i=(m=s.providerUserInfo)!=null&&m.length?od(s.providerUserInfo):[],a=zy(n.providerData,i),u=n.isAnonymous,l=!(n.email&&s.passwordHash)&&!(a!=null&&a.length),d=u?l:!1,f={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:a,metadata:new So(s.createdAt,s.lastLoginAt),isAnonymous:d};Object.assign(n,f)}async function jy(n){const e=Le(n);await Ks(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function zy(n,e){return[...n.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function od(n){return n.map(({providerId:e,...t})=>({providerId:e,uid:t.rawId||"",displayName:t.displayName||null,email:t.email||null,phoneNumber:t.phoneNumber||null,photoURL:t.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gy(n,e){const t=await sd(n,{},async()=>{const r=Gr({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:i}=n.config,a=await id(n,s,"/v1/token",`key=${i}`),u=await n._getAdditionalHeaders();u["Content-Type"]="application/x-www-form-urlencoded";const l={method:"POST",headers:u,body:r};return n.emulatorConfig&&jn(n.emulatorConfig.host)&&(l.credentials="include"),rd.fetch()(a,l)});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function Wy(n,e){return Gt(n,"POST","/v2/accounts:revokeToken",mn(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qu=new Map;function lt(n){gt(n instanceof Function,"Expected a class definition");let e=qu.get(n);return e?(gt(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,qu.set(n,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Cs(n,e,t){return`firebase:${n}:${e}:${t}`}class Nn{constructor(e,t,r){this.persistence=e,this.auth=t,this.userKey=r;const{config:s,name:i}=this.auth;this.fullUserKey=Cs(this.userKey,s.apiKey,i),this.fullPersistenceKey=Cs("persistence",s.apiKey,i),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);if(!e)return null;if(typeof e=="string"){const t=await Ws(this.auth,{idToken:e}).catch(()=>{});return t?Ke._fromGetAccountInfoResponse(this.auth,t,e):null}return Ke._fromJSON(this.auth,e)}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,r="authUser"){if(!t.length)return new Nn(lt($u),e,r);const s=(await Promise.all(t.map(async d=>{if(await d._isAvailable())return d}))).filter(d=>d);let i=s[0]||lt($u);const a=Cs(r,e.config.apiKey,e.name);let u=null;for(const d of t)try{const f=await d._get(a);if(f){let m;if(typeof f=="string"){const I=await Ws(e,{idToken:f}).catch(()=>{});if(!I)break;m=await Ke._fromGetAccountInfoResponse(e,I,f)}else m=Ke._fromJSON(e,f);d!==i&&(u=m),i=d;break}}catch{}const l=s.filter(d=>d._shouldAllowMigration);return!i._shouldAllowMigration||!l.length?new Nn(i,e,r):(i=l[0],u&&await i._set(a,u.toJSON()),await Promise.all(t.map(async d=>{if(d!==i)try{await d._remove(a)}catch{}})),new Nn(i,e,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let mi={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function tE(n){mi=n}function _d(n){return mi.loadJS(n)}function nE(){return mi.recaptchaEnterpriseScript}function rE(){return mi.gapiScript}function sE(n){return`__${n}${Math.floor(Math.random()*1e6)}`}class iE{constructor(){this.enterprise=new oE}ready(e){e()}execute(e,t){return Promise.resolve("token")}render(e,t){return""}}class oE{ready(e){e()}execute(e,t){return Promise.resolve("token")}render(e,t){return""}}const aE="recaptcha-enterprise",yd="NO_RECAPTCHA";class cE{constructor(e){this.type=aE,this.auth=Xn(e)}async verify(e="verify",t=!1){async function r(i){if(!t){if(i.tenantId==null&&i._agentRecaptchaConfig!=null)return i._agentRecaptchaConfig.siteKey;if(i.tenantId!=null&&i._tenantRecaptchaConfigs[i.tenantId]!==void 0)return i._tenantRecaptchaConfigs[i.tenantId].siteKey}return new Promise(async(a,u)=>{Uy(i,{clientType:"CLIENT_TYPE_WEB",version:"RECAPTCHA_ENTERPRISE"}).then(l=>{if(l.recaptchaKey===void 0)u(new Error("recaptcha Enterprise site key undefined"));else{const d=new Fy(l);return i.tenantId==null?i._agentRecaptchaConfig=d:i._tenantRecaptchaConfigs[i.tenantId]=d,a(d.siteKey)}}).catch(l=>{u(l)})})}function s(i,a,u){const l=window.grecaptcha;Uu(l)?l.enterprise.ready(()=>{l.enterprise.execute(i,{action:e}).then(d=>{a(d)}).catch(()=>{a(yd)})}):u(Error("No reCAPTCHA enterprise script loaded."))}return this.auth.settings.appVerificationDisabledForTesting?new iE().execute("siteKey",{action:"verify"}):new Promise((i,a)=>{r(this.auth).then(u=>{if(!t&&Uu(window.grecaptcha))s(u,i,a);else{if(typeof window>"u"){a(new Error("RecaptchaVerifier is only supported in browser"));return}let l=nE();l.length!==0&&(l+=u),_d(l).then(()=>{s(u,i,a)}).catch(d=>{a(d)})}}).catch(u=>{a(u)})})}}async function zu(n,e,t,r=!1,s=!1){const i=new cE(n);let a;if(s)a=yd;else try{a=await i.verify(t)}catch{a=await i.verify(t,!0)}const u={...e};if(t==="mfaSmsEnrollment"||t==="mfaSmsSignIn"){if("phoneEnrollmentInfo"in u){const l=u.phoneEnrollmentInfo.phoneNumber,d=u.phoneEnrollmentInfo.recaptchaToken;Object.assign(u,{phoneEnrollmentInfo:{phoneNumber:l,recaptchaToken:d,captchaResponse:a,clientType:"CLIENT_TYPE_WEB",recaptchaVersion:"RECAPTCHA_ENTERPRISE"}})}else if("phoneSignInInfo"in u){const l=u.phoneSignInInfo.recaptchaToken;Object.assign(u,{phoneSignInInfo:{recaptchaToken:l,captchaResponse:a,clientType:"CLIENT_TYPE_WEB",recaptchaVersion:"RECAPTCHA_ENTERPRISE"}})}return u}return r?Object.assign(u,{captchaResp:a}):Object.assign(u,{captchaResponse:a}),Object.assign(u,{clientType:"CLIENT_TYPE_WEB"}),Object.assign(u,{recaptchaVersion:"RECAPTCHA_ENTERPRISE"}),u}async function Gu(n,e,t,r,s){var i;if((i=n._getRecaptchaConfig())!=null&&i.isProviderEnabled("EMAIL_PASSWORD_PROVIDER")){const a=await zu(n,e,t,t==="getOobCode");return r(n,a)}else return r(n,e).catch(async a=>{if(a.code==="auth/missing-recaptcha-token"){console.log(`${t} is protected by reCAPTCHA Enterprise for this project. Automatically triggering the reCAPTCHA flow and restarting the flow.`);const u=await zu(n,e,t,t==="getOobCode");return r(n,u)}else return Promise.reject(a)})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function uE(n,e){const t=No(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),i=t.getOptions();if(rn(i,e??{}))return s;Xe(s,"already-initialized")}return t.initialize({options:e})}function lE(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(lt);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function hE(n,e,t){const r=Xn(n);B(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,i=Ed(e),{host:a,port:u}=dE(e),l=u===null?"":`:${u}`,d={url:`${i}//${a}${l}/`},f=Object.freeze({host:a,port:u,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})});if(!r._canInitEmulator){B(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),B(rn(d,r.config.emulator)&&rn(f,r.emulatorConfig),r,"emulator-config-failed");return}r.config.emulator=d,r.emulatorConfig=f,r.settings.appVerificationDisabledForTesting=!0,jn(a)?(fl(`${i}//${a}${l}`),pl("Auth",!0)):fE()}function Ed(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function dE(n){const e=Ed(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const i=s[1];return{host:i,port:Wu(r.substr(i.length+1))}}else{const[i,a]=r.split(":");return{host:i,port:Wu(a)}}}function Wu(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function fE(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ia{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return ut("not implemented")}_getIdTokenResponse(e){return ut("not implemented")}_linkToIdToken(e,t){return ut("not implemented")}_getReauthenticationResolver(e){return ut("not implemented")}}async function pE(n,e){return Gt(n,"POST","/v1/accounts:signUp",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jn{constructor(){this.providerId=Jn.PROVIDER_ID}static credential(e,t){return jr._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const r=Ta.parseLink(t);return B(r,"argument-error"),jr._fromEmailAndCode(e,r.code,r.tenantId)}}Jn.PROVIDER_ID="password";Jn.EMAIL_PASSWORD_SIGN_IN_METHOD="password";Jn.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zr extends Id{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bt extends Zr{constructor(){super("facebook.com")}static credential(e){return un._fromParams({providerId:bt.PROVIDER_ID,signInMethod:bt.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return bt.credentialFromTaggedObject(e)}static credentialFromError(e){return bt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return bt.credential(e.oauthAccessToken)}catch{return null}}}bt.FACEBOOK_SIGN_IN_METHOD="facebook.com";bt.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ct extends Zr{constructor(){super("google.com"),this.addScope("profile")}static credential(e,t){return un._fromParams({providerId:Ct.PROVIDER_ID,signInMethod:Ct.GOOGLE_SIGN_IN_METHOD,idToken:e,accessToken:t})}static credentialFromResult(e){return Ct.credentialFromTaggedObject(e)}static credentialFromError(e){return Ct.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthIdToken:t,oauthAccessToken:r}=e;if(!t&&!r)return null;try{return Ct.credential(t,r)}catch{return null}}}Ct.GOOGLE_SIGN_IN_METHOD="google.com";Ct.PROVIDER_ID="google.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ot extends Zr{constructor(){super("github.com")}static credential(e){return un._fromParams({providerId:Ot.PROVIDER_ID,signInMethod:Ot.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Ot.credentialFromTaggedObject(e)}static credentialFromError(e){return Ot.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Ot.credential(e.oauthAccessToken)}catch{return null}}}Ot.GITHUB_SIGN_IN_METHOD="github.com";Ot.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nt extends Zr{constructor(){super("twitter.com")}static credential(e,t){return un._fromParams({providerId:Nt.PROVIDER_ID,signInMethod:Nt.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:t})}static credentialFromResult(e){return Nt.credentialFromTaggedObject(e)}static credentialFromError(e){return Nt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthAccessToken:t,oauthTokenSecret:r}=e;if(!t||!r)return null;try{return Nt.credential(t,r)}catch{return null}}}Nt.TWITTER_SIGN_IN_METHOD="twitter.com";Nt.PROVIDER_ID="twitter.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function wE(n,e,t=!1){const{auth:r}=n;if(Ge(r.app))return Promise.reject(Ft(r));const s="reauthenticate";try{const i=await Hr(n,Td(r,s,e,n),t);B(i.idToken,r,"internal-error");const a=ya(i.idToken);B(a,r,"internal-error");const{sub:u}=a;return B(n.uid===u,r,"user-mismatch"),qn._forOperation(n,s,i)}catch(i){throw(i==null?void 0:i.code)==="auth/user-not-found"&&Xe(r,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zE(n,e){return e?lt(e):(B(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kd{constructor(e,t,r,s,i=!1){this.auth=e,this.resolver=r,this.user=s,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:r,postBody:s,tenantId:i,error:a,type:u}=e;if(a){this.reject(a);return}const l={auth:this.auth,requestUri:t,sessionId:r,tenantId:i||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(u)(l))}catch(d){this.reject(d)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return GE;case"linkViaPopup":case"linkViaRedirect":return KE;case"reauthViaPopup":case"reauthViaRedirect":return WE;default:Xe(this.auth,"internal-error")}}resolve(e){gt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){gt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const YE="pendingRedirect",Os=new Map;class XE extends kd{constructor(e,t,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,r),this.eventId=null}async execute(){let e=Os.get(this.auth._key());if(!e){try{const r=await JE(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(t){e=()=>Promise.reject(t)}Os.set(this.auth._key(),e)}return this.bypassAuthState||Os.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function JE(n,e){const t=tI(e),r=eI(n);if(!await r._isAvailable())return!1;const s=await r._get(t)==="true";return await r._remove(t),s}function ZE(n,e){Os.set(n._key(),e)}function eI(n){return lt(n._redirectPersistence)}function tI(n){return Cs(YE,n.config.apiKey,n.name)}async function nI(n,e,t=!1){if(Ge(n.app))return Promise.reject(Ft(n));const r=Xn(n),s=zE(r,e),a=await new XE(r,s,t).execute();return a&&!t&&(delete a.user._redirectEventId,await r._persistUserIfCurrent(a.user),await r._setRedirectUser(null,e)),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hI=new Jr(3e4,6e4);function Ju(){const n=ot().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function dI(n){return new Promise((e,t)=>{var s,i,a;function r(){Ju(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Ju(),t(it(n,"network-request-failed"))},timeout:hI.get()})}if((i=(s=ot().gapi)==null?void 0:s.iframes)!=null&&i.Iframe)e(gapi.iframes.getContext());else if((a=ot().gapi)!=null&&a.load)r();else{const u=sE("iframefcb");return ot()[u]=()=>{gapi.load?r():t(it(n,"network-request-failed"))},_d(`${rE()}?onload=${u}`).catch(l=>t(l))}}).catch(e=>{throw Ns=null,e})}let Ns=null;function fI(n){return Ns=Ns||dI(n),Ns}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pI=new Jr(5e3,15e3),mI="__/auth/iframe",gI="emulator/auth/iframe",_I={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},yI=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function EI(n){const e=n.config;B(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?_a(e,gI):`https://${n.config.authDomain}/${mI}`,r={apiKey:e.apiKey,appName:n.name,v:zn},s=yI.get(n.config.apiHost);s&&(r.eid=s);const i=n._getFrameworks();return i.length&&(r.fw=i.join(",")),`${t}?${Gr(r).slice(1)}`}async function II(n){const e=await fI(n),t=ot().gapi;return B(t,n,"internal-error"),e.open({where:document.body,url:EI(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:_I,dontclear:!0},r=>new Promise(async(s,i)=>{await r.restyle({setHideOnLeave:!1});const a=it(n,"network-request-failed"),u=ot().setTimeout(()=>{i(a)},pI.get());function l(){ot().clearTimeout(u),s(r)}r.ping(l).then(l,()=>{i(a)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const to="webStorageSupport";class kI{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Sd,this._completeRedirectFn=nI,this._overrideRedirectResult=ZE}async _openPopup(e,t,r,s){var a;gt((a=this.eventManagers[e._key()])==null?void 0:a.manager,"_initialize() not called before _openPopup()");const i=await el(e,t,r,Ro(),s);return SI(e,i,wa())}async _openRedirect(e,t,r,s){await this._originValidation(e);const i=await el(e,t,r,Ro(),s);return ME(i),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:i}=this.eventManagers[t];return s?Promise.resolve(s):(gt(i,"If manager is not set, promise should be"),i)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await II(e),r=new sI(e);return t.register("authEvent",s=>(B(s==null?void 0:s.authEvent,e,"invalid-auth-event"),{status:r.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(to,{type:to},s=>{var a;const i=(a=s==null?void 0:s[0])==null?void 0:a[to];i!==void 0&&t(!!i),Xe(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=uI(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return md()||ud()||Ea()}}const DI=kI;var tl="@firebase/auth",nl="1.12.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
